...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:11:0x0038 in {5, 6, 7, 10} preds:[]
...
*/
    ...
    L_0x0002:
        r0 = r4.keySet();	 Catch:{ IOException -> 0x0031 }
        r1 = r3.mCurrentOutput;	 Catch:{ IOException -> 0x0031 }
        r2 = r0.size();	 Catch:{ IOException -> 0x0031 }
        r1.writeInt(r2);	 Catch:{ IOException -> 0x0031 }
        r0 = r0.iterator();	 Catch:{ IOException -> 0x0031 }
    L_0x0013:
        r1 = r0.hasNext();	 Catch:{ IOException -> 0x0031 }
        if (r1 == 0) goto L_0x0030;	 Catch:{ IOException -> 0x0031 }
    L_0x0019:
        r1 = r0.next();	 Catch:{ IOException -> 0x0031 }
        r1 = (java.lang.String) r1;	 Catch:{ IOException -> 0x0031 }
        r3.writeString(r1);	 Catch:{ IOException -> 0x0031 }
        r1 = r4.get(r1);	 Catch:{ IOException -> 0x0031 }
        r3.writeObject(r1);	 Catch:{ IOException -> 0x0031 }
        goto L_0x0013;	 Catch:{ IOException -> 0x0031 }
    L_0x002a:
        r4 = r3.mCurrentOutput;	 Catch:{ IOException -> 0x0031 }
        r0 = -1;	 Catch:{ IOException -> 0x0031 }
        r4.writeInt(r0);	 Catch:{ IOException -> 0x0031 }
    L_0x0030:
        return;
    L_0x0031:
        r4 = move-exception;
        r0 = new androidx.versionedparcelable.VersionedParcel$ParcelException;
        r0.<init>(r4);
        throw r0;
        return;
        */
