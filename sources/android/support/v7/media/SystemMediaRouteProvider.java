...
abstract class SystemMediaRouteProvider extends MediaRouteProvider {
    ...
    static class JellybeanImpl extends SystemMediaRouteProvider implements Callback, VolumeCallback {
        ...
        public JellybeanImpl(Context context, SyncCallback syncCallback) {
            ...
            this.mUserRouteCategoryObj = MediaRouterJellybean.createRouteCategory(this.mRouterObj, context.getResources().getString(C0303R.string.mr_user_route_category_name), false);
            updateSystemRoutes();
        }
        ...
        public void onRouteVolumeChanged(Object obj) {
            if (getUserRouteRecord(obj) == null) {
                ...
                if (findSystemRouteRecord >= 0) {
                    ...
                    obj = MediaRouterJellybean.RouteInfo.getVolume(obj);
        ...
        protected Object getSystemRoute(RouteInfo routeInfo) {
            if (routeInfo == null) {
                return null;
            }
            routeInfo = findSystemRouteRecordByDescriptorId(routeInfo.getDescriptorId());
    ...
    static class LegacyImpl extends SystemMediaRouteProvider {
        ...
        void publishRoutes() {
            ...
            setDescriptor(new MediaRouteProviderDescriptor.Builder().addRoute(new Builder(SystemMediaRouteProvider.DEFAULT_ROUTE_ID, resources.getString(C0303R.string.mr_system_route_name)).addControlFilters(CONTROL_FILTERS).setPlaybackStream(3).setPlaybackType(0).setVolumeHandling(1).setVolumeMax(streamMaxVolume).setVolume(this.mLastReportedVolume).build()).build());
        }
