...
final class RegisteredMediaRouteProviderWatcher {
    ...
    private final BroadcastReceiver mScanPackagesReceiver = new C03011();
    private final Runnable mScanPackagesRunnable = new C03022();

    /* renamed from: android.support.v7.media.RegisteredMediaRouteProviderWatcher$1 */
    class C03011 extends BroadcastReceiver {
        C03011() {
        }
        ...
        if (this.mRunning) {
            ...
            for (ResolveInfo resolveInfo : this.mPackageManager.queryIntentServices(new Intent("android.media.MediaRouteProviderService"), 0)) {
                ...
                if (serviceInfo != null) {
                    ...
                    int i2;
                    if (findProvider < 0) {
                        MediaRouteProvider registeredMediaRouteProvider2 = new RegisteredMediaRouteProvider(this.mContext, new ComponentName(serviceInfo.packageName, serviceInfo.name));
