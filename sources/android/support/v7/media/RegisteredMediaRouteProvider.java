...
*/
        ...
        public void dispose() {
            ...
            RegisteredMediaRouteProvider.this.mPrivateHandler.post(new C02991());
        }
        ...
        public void binderDied() {
            RegisteredMediaRouteProvider.this.mPrivateHandler.post(new C03002());
        }
...
*/
    ...
    private final class Controller extends RouteController {
        ...
        public boolean onControlRequest(Intent intent, ControlRequestCallback controlRequestCallback) {
            Connection connection = this.mConnection;
            return connection != null ? connection.sendControlRequest(this.mControllerId, intent, controlRequestCallback) : null;
        }
    }
