...
final class OverlayListView extends ListView {
    ...
    public static class OverlayObject {
        ...
        public boolean update(long j) {
            ...
            float f;
            j = Math.max(0.0f, Math.min(1.0f, ((float) (j - this.mStartTime)) / ((float) this.mDuration)));
            ...
            if (interpolator == null) {
                ...
                f = interpolator.getInterpolation(j);
            }
            ...
            if (this.mIsAnimationStarted && j >= 1065353216) {
                this.mIsAnimationEnded = true;
                j = this.mListener;
                if (j != null) {
                    j.onAnimationEnd();
