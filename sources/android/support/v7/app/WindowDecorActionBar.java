...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C06661();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C06672();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C05163();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C05163 implements ViewPropertyAnimatorUpdateListener {
        C05163() {
        }
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public boolean onMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
            ...
            return menuBuilder != null ? menuBuilder.onActionItemClicked(this, menuItem) : null;
        }
    ...
    class C06661 extends ViewPropertyAnimatorListenerAdapter {
        ...
        public void onAnimationEnd(View view) {
            ...
            view.completeDeferredDestroyActionMode();
    ...
    class C06672 extends ViewPropertyAnimatorListenerAdapter {
        C06672() {
        }
        ...
        public void onAnimationEnd(View view) {
            view = WindowDecorActionBar.this;
            view.mCurrentShowAnim = null;
            view.mContainerView.requestLayout();
        }
    }
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:9:0x002f in {5, 6, 8} preds:[]
...
*/
        /*
        r1 = this;
        r2 = (android.support.v7.app.WindowDecorActionBar.TabImpl) r2;
        r0 = r2.getCallback();
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0291R.id.decor_content_parent);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0291R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0291R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0291R.id.action_bar_container);
        view = this.mDecorToolbar;
        if (view == null || this.mContextView == null || this.mContainerView == null) {
        ...
        if (!actionBarPolicy.enableHomeButtonByDefault()) {
            if (view == null) {
                ...
                view = this.mContext.obtainStyledAttributes(null, C0291R.styleable.ActionBar, C0291R.attr.actionBarStyle, 0);
                if (view.getBoolean(C0291R.styleable.ActionBar_hideOnContentScroll, false)) {
                    setHideOnContentScrollEnabled(true);
                }
                dimensionPixelSize = view.getDimensionPixelSize(C0291R.styleable.ActionBar_elevation, 0);
    ...
    public ActionMode startActionMode(Callback callback) {
        ...
        if (actionModeImpl2.dispatchOnCreate() == null) {
            return null;
        }
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0291R.attr.actionBarWidgetTheme, typedValue, true);
