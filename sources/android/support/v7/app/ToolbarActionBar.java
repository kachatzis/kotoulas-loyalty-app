...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C05152();
    private final Runnable mMenuInvalidator = new C02901();
    ...
    class C05152 implements OnMenuItemClickListener {
        C05152() {
        }
...
*/
    ...
    public void setTitle(int i) {
        ...
        decorToolbar.setTitle(i != 0 ? decorToolbar.getContext().getText(i) : 0);
    }
    ...
    public void setSubtitle(int i) {
        DecorToolbar decorToolbar = this.mDecorToolbar;
        decorToolbar.setSubtitle(i != 0 ? decorToolbar.getContext().getText(i) : 0);
    }
