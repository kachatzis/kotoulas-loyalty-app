...
class MediaRouteVolumeSlider extends AppCompatSeekBar {
    ...
    public MediaRouteVolumeSlider(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0291R.attr.seekBarStyle);
    }
    ...
    public void setThumb(Drawable drawable) {
        ...
        super.setThumb(this.mHideThumb != null ? null : this.mThumb);
    }

    public void setHideThumb(boolean z) {
        if (this.mHideThumb != z) {
            this.mHideThumb = z;
            super.setThumb(this.mHideThumb ? false : this.mThumb);
        }
    }
