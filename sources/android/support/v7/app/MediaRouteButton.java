...
public class MediaRouteButton extends View {
    ...
    public MediaRouteButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0303R.attr.mediaRouteButtonStyle);
    }
    ...
    public MediaRouteButton(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0303R.styleable.MediaRouteButton, i, 0);
        this.mButtonTint = context.getColorStateList(C0303R.styleable.MediaRouteButton_mediaRouteButtonTint);
        this.mMinWidth = context.getDimensionPixelSize(C0303R.styleable.MediaRouteButton_android_minWidth, 0);
        this.mMinHeight = context.getDimensionPixelSize(C0303R.styleable.MediaRouteButton_android_minHeight, 0);
        attributeSet = context.getResourceId(C0303R.styleable.MediaRouteButton_externalRouteEnabledDrawable, 0);
        context.recycle();
    ...
    void setCheatSheetEnabled(boolean z) {
        TooltipCompat.setTooltipText(this, z ? getContext().getString(C0303R.string.mr_button_content_description) : false);
    }
    ...
    public void setRemoteIndicatorDrawable(Drawable drawable) {
        ...
        if (this.mAttachedToWindow != null) {
            drawable = this.mRemoteIndicator;
            if (drawable != null && (drawable.getCurrent() instanceof AnimationDrawable) != null) {
    ...
    public void setVisibility(int i) {
        ...
        i = this.mRemoteIndicator;
        if (i != 0) {
            i.setVisible(getVisibility() == 0, false);
        }
    }
    ...
    private void updateContentDescription() {
        int i;
        if (this.mIsConnecting) {
            i = C0303R.string.mr_cast_button_connecting;
        } else if (this.mRemoteActive) {
            i = C0303R.string.mr_cast_button_connected;
        } else {
            i = C0303R.string.mr_cast_button_disconnected;
        }
