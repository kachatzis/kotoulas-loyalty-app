...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:18:0x008d in {7, 10, 11, 14, 15, 17} preds:[]
...
*/
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        attributeSet = context.obtainStyledAttributes(attributeSet, C0291R.styleable.View, 0, 0);
        int resourceId = z ? attributeSet.getResourceId(C0291R.styleable.View_android_theme, 0) : false;
        if (z2 && !resourceId != false) {
            resourceId = attributeSet.getResourceId(C0291R.styleable.View_theme, 0);
            if (resourceId == true) {
