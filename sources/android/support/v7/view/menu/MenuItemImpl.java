...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    class C05291 implements VisibilityListener {
        C05291() {
        }
    ...
    String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            stringBuilder.append(resources.getString(C0291R.string.abc_prepend_shortcut_label));
        }
        int i = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(stringBuilder, i, 65536, resources.getString(C0291R.string.abc_menu_meta_shortcut_label));
        appendModifier(stringBuilder, i, 4096, resources.getString(C0291R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(stringBuilder, i, 2, resources.getString(C0291R.string.abc_menu_alt_shortcut_label));
        appendModifier(stringBuilder, i, 1, resources.getString(C0291R.string.abc_menu_shift_shortcut_label));
        appendModifier(stringBuilder, i, 4, resources.getString(C0291R.string.abc_menu_sym_shortcut_label));
        appendModifier(stringBuilder, i, 8, resources.getString(C0291R.string.abc_menu_function_shortcut_label));
        if (shortcut == '\b') {
            stringBuilder.append(resources.getString(C0291R.string.abc_menu_delete_shortcut_label));
        } else if (shortcut == '\n') {
            stringBuilder.append(resources.getString(C0291R.string.abc_menu_enter_shortcut_label));
        } else if (shortcut != ' ') {
            stringBuilder.append(shortcut);
        } else {
            stringBuilder.append(resources.getString(C0291R.string.abc_menu_space_shortcut_label));
        }
    ...
    public SupportMenuItem setSupportActionProvider(ActionProvider actionProvider) {
        ...
        if (actionProvider != null) {
            actionProvider.setVisibilityListener(new C05291());
        }
        return this;
    }
