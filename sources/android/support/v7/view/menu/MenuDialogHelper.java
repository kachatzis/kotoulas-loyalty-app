...
class MenuDialogHelper implements OnKeyListener, OnClickListener, OnDismissListener, Callback {
    ...
    public void show(IBinder iBinder) {
        ...
        this.mPresenter = new ListMenuPresenter(builder.getContext(), C0291R.layout.abc_list_menu_item_layout);
    ...
    public boolean onOpenSubMenu(MenuBuilder menuBuilder) {
        Callback callback = this.mPresenterCallback;
        return callback != null ? callback.onOpenSubMenu(menuBuilder) : null;
    }
