...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C0291R.layout.abc_cascading_menu_item_layout;
    static final int SUBMENU_TIMEOUT_MS = 200;
    private View mAnchorView;
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C03122();
    private final Context mContext;
    private int mDropDownGravity = 0;
    private boolean mForceShowIcon;
    final OnGlobalLayoutListener mGlobalLayoutListener = new C03111();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C05283();
    ...
    class C03111 implements OnGlobalLayoutListener {
        C03111() {
        }
    ...
    class C03122 implements OnAttachStateChangeListener {
    ...
    class C05283 implements MenuItemHoverListener {
        C05283() {
        }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(context.getDisplayMetrics().widthPixels / 2, context.getDimensionPixelSize(C0291R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) from.inflate(C0291R.layout.abc_popup_menu_header_item_layout, listView, false);
    ...
    public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
        ...
        if (findIndexOfAddedMenu >= 0) {
            ...
            if (findIndexOfAddedMenu == 0) {
                dismiss();
                z = this.mPresenterCallback;
                if (z) {
                    z.onCloseMenu(menuBuilder, true);
                }
                menuBuilder = this.mTreeObserver;
                if (menuBuilder != null) {
                    if (menuBuilder.isAlive() != null) {
