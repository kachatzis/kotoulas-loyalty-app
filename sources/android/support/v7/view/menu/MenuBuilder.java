...
public class MenuBuilder implements SupportMenu {
    ...
    protected MenuItem addInternal(int i, int i2, int i3, CharSequence charSequence) {
        ...
        i2 = this.mCurrentMenuInfo;
        if (i2 != 0) {
            i.setMenuInfo(i2);
        }
        i2 = this.mItems;
        i2.add(findInsertIndex(i2, ordering), i);
        onItemsChanged(1);
        return i;
    }
    ...
    private void setShortcutsVisibleInner(boolean z) {
        boolean z2 = true;
        if (!z || this.mResources.getConfiguration().keyboard || !ViewConfigurationCompat.shouldShowMenuShortcutsWhenKeyboardPresent(ViewConfiguration.get(this.mContext), this.mContext)) {
            z2 = false;
        }
    ...
    boolean dispatchMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
        ...
        return (callback == null || callback.onMenuItemSelected(menuBuilder, menuItem) == null) ? null : true;
    }
