...
*/
            ...
            r12 = r4.openFileOutput(r12, r0);	 Catch:{ FileNotFoundException -> 0x00e8 }
        ...
        L_0x0077:
            r0 = move-exception;
            r1 = android.support.v7.widget.ActivityChooserModel.LOG_TAG;	 Catch:{ all -> 0x0075 }
            r4 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0075 }
            ...
            r4.append(r5);	 Catch:{ all -> 0x0075 }
            r4 = r4.toString();	 Catch:{ all -> 0x0075 }
    ...
    public int getActivityIndex(android.content.pm.ResolveInfo r6) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:16:0x0024 in {8, 9, 12, 15} preds:[]
...
*/
        ...
        r0 = r5.mInstanceLock;
        monitor-enter(r0);
        r5.ensureConsistentState();	 Catch:{ all -> 0x0021 }
        r1 = r5.mActivities;	 Catch:{ all -> 0x0021 }
