    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        for (i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0291R.id.topPanel) {
                    view = childAt;
                } else if (id == C0291R.id.buttonPanel) {
                    view2 = childAt;
                } else {
                    if (id != C0291R.id.contentPanel) {
                        if (id != C0291R.id.customPanel) {
                            return false;
                        }
                    }
                    if (view3 != null) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (!(childAt == null || childAt.getVisibility() == 8)) {
                ...
                i7 = GravityCompat.getAbsoluteGravity(i7, ViewCompat.getLayoutDirection(this)) & 7;
                if (i7 == 1) {
                ...
                setChildFrame(childAt, i7, i10, measuredWidth, measuredHeight);
