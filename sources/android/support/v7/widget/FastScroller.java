...
class FastScroller extends ItemDecoration implements OnItemTouchListener {
    ...
    private final Runnable mHideRunnable = new C03391();
    @VisibleForTesting
    ...
    private final OnScrollListener mOnScrollListener = new C05372();
    ...
    class C05372 extends OnScrollListener {
        C05372() {
        }
    ...
    boolean isPointInsideHorizontalThumb(float f, float f2) {
        if (f2 >= ((float) (this.mRecyclerViewHeight - this.mHorizontalThumbHeight))) {
            f2 = this.mHorizontalThumbCenterX;
            int i = this.mHorizontalThumbWidth;
            if (f >= ((float) (f2 - (i / 2))) && f <= ((float) (f2 + (i / 2)))) {
                return true;
            }
        }
        return false;
