...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public Object getItem(int i) {
            SpinnerAdapter spinnerAdapter = this.mAdapter;
            return spinnerAdapter == null ? 0 : spinnerAdapter.getItem(i);
        }
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C03292 implements OnGlobalLayoutListener {
            C03292() {
            }
        ...
        public void show() {
            ...
            if (!isShowing) {
                ...
                if (viewTreeObserver != null) {
                    final OnGlobalLayoutListener c03292 = new C03292();
                    viewTreeObserver.addOnGlobalLayoutListener(c03292);
                    setOnDismissListener(new OnDismissListener() {
                        public void onDismiss() {
                            ViewTreeObserver viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver();
                            if (viewTreeObserver != null) {
                                viewTreeObserver.removeGlobalOnLayoutListener(c03292);
                            }
                        }
                    });
                }
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, null, C0291R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0291R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(android.content.Context r8, android.util.AttributeSet r9, int r10, int r11, android.content.res.Resources.Theme r12) {
        ...
        r0.<init>();
        r7.mTempRect = r0;
        r0 = android.support.v7.appcompat.C0291R.styleable.Spinner;
        r1 = 0;
    ...
    L_0x001b:
        ...
        goto L_0x003e;
    L_0x0023:
        r12 = android.support.v7.appcompat.C0291R.styleable.Spinner_popupTheme;
    ...
    L_0x0076:
        ...
        r11.<init>(r12, r9, r10);
        r12 = r7.mPopupContext;
        r4 = android.support.v7.appcompat.C0291R.styleable.Spinner;
        r12 = android.support.v7.widget.TintTypedArray.obtainStyledAttributes(r12, r9, r4, r10, r1);
        r1 = android.support.v7.appcompat.C0291R.styleable.Spinner_android_dropDownWidth;
        r4 = -2;
        r1 = r12.getLayoutDimension(r1, r4);
        r7.mDropDownWidth = r1;
        r1 = android.support.v7.appcompat.C0291R.styleable.Spinner_android_popupBackground;
        r1 = r12.getDrawable(r1);
        r11.setBackgroundDrawable(r1);
        r1 = android.support.v7.appcompat.C0291R.styleable.Spinner_android_prompt;
        r1 = r0.getString(r1);
    ...
    L_0x00ac:
        r11 = android.support.v7.appcompat.C0291R.styleable.Spinner_android_entries;
    ...
    L_0x00b4:
        ...
        r12.<init>(r8, r1, r11);
        r8 = android.support.v7.appcompat.C0291R.layout.support_simple_spinner_dropdown_item;
