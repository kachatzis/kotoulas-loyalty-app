...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayout {
        ...
        public TabView(Context context, Tab tab, boolean z) {
            super(context, null, C0291R.attr.actionBarTabStyle);
            this.mTab = tab;
            ScrollingTabContainerView obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0291R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (isEmpty != 0) {
                if (this.mTextView == null) {
                    View appCompatTextView = new AppCompatTextView(getContext(), null, C0291R.attr.actionBarTabTextStyle);
    ...
    protected class VisibilityAnimListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            if (this.mCanceled == null) {
                animator = ScrollingTabContainerView.this;
                animator.mVisibilityAnim = null;
                animator.setVisibility(this.mFinalVisibility);
            }
        }
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0291R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0291R.attr.actionDropDownStyle);
    ...
    public void addTab(Tab tab, int i, boolean z) {
        ...
        i = this.mTabSpinner;
        if (i != 0) {
            ((TabAdapter) i.getAdapter()).notifyDataSetChanged();
        }
        if (z) {
            tab.setSelected(1);
        }
