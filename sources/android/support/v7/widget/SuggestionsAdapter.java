...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0291R.id.edit_query);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) context.findViewById(C0291R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return context;
    }

    public void bindView(View view, Context context, Cursor cursor) {
        ChildViewCache childViewCache = (ChildViewCache) view.getTag();
        context = this.mFlagsCol;
        context = context != -1 ? cursor.getInt(context) : null;
        ...
        cursor = this.mQueryRefinement;
        if (cursor != 2) {
            if (cursor != 1 || (context & 1) == null) {
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0291R.attr.textColorSearchUrl, typedValue, true);
...
*/
    ...
    L_0x000d:
        r7 = r6.getDrawableFromResourceUri(r7);	 Catch:{ NotFoundException -> 0x0012 }
        return r7;
    L_0x0012:
