...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C03473();
    ...
    static class C03473 implements Interpolator {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C05461();
        ...
        private final Callback mVerticalBoundCheckCallback = new C05472();
        private int mWidth;
        ...
        class C05461 implements Callback {
            C05461() {
            }
        ...
        class C05472 implements Callback {
            C05472() {
            }
        ...
        public final void setItemPrefetchEnabled(boolean z) {
            if (z != this.mItemPrefetchEnabled) {
                ...
                if (z) {
                    z.mRecycler.updateViewCacheSize();
                }
            }
        }
        ...
        public boolean removeCallbacks(Runnable runnable) {
            RecyclerView recyclerView = this.mRecyclerView;
            return recyclerView != null ? recyclerView.removeCallbacks(runnable) : null;
        }
                    ...
                    if (!childViewHolderInt.wasReturnedFromScrap()) {
                        if (childViewHolderInt.isScrap()) {
                            if (view.getParent() != this.mRecyclerView) {
                                ...
                                i = this.mSmoothScroller;
                                if (!(i == 0 || i.isRunning() == 0)) {
        ...
        public View getChildAt(int i) {
            ChildHelper childHelper = this.mChildHelper;
            return childHelper != null ? childHelper.getChildAt(i) : 0;
        }
        ...
        private int[] getChildRectangleOnScreenScrollAmount(RecyclerView recyclerView, View view, Rect rect, boolean z) {
            ...
            if (getLayoutDirection() != 1) {
                width = min != 0 ? min : Math.min(left, width);
            } else if (width == 0) {
        ...
        public void onInitializeAccessibilityEvent(@NonNull Recycler recycler, @NonNull State state, @NonNull AccessibilityEvent accessibilityEvent) {
            ...
            if (recycler != null) {
                if (accessibilityEvent != null) {
                    state = true;
                    if (recycler.canScrollVertically(1) == null && this.mRecyclerView.canScrollVertically(-1) == null && this.mRecyclerView.canScrollHorizontally(-1) == null) {
        ...
        public boolean performAccessibilityAction(@NonNull Recycler recycler, @NonNull State state, int i, @Nullable Bundle bundle) {
            ...
            if (i == 4096) {
                recycler = recycler.canScrollVertically(1) != null ? (getHeight() - getPaddingTop()) - getPaddingBottom() : null;
                i = this.mRecyclerView.canScrollHorizontally(1) != 0 ? (getWidth() - getPaddingLeft()) - getPaddingRight() : 0;
            } else if (i != 8192) {
                recycler = null;
                i = 0;
            } else {
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0305R.styleable.RecyclerView, i, i2);
            properties.orientation = context.getInt(C0305R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = context.getInt(C0305R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = context.getBoolean(C0305R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = context.getBoolean(C0305R.styleable.RecyclerView_stackFromEnd, false);
            context.recycle();
            return properties;
        }
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:60:0x011f in {4, 14, 15, 19, 20, 28, 38, 39, 40, 41, 42, 44, 49, 50, 52, 54, 57, 59} preds:[]
...
*/
        ...
        L_0x005a:
            ...
            r3 = r3 + -1;
        L_0x005f:
            r4 = android.support.v7.widget.RecyclerView.ALLOW_THREAD_GAP_WORK;
        ...
        L_0x0075:
            r4 = r6.mCachedViews;
            r4 = r4.get(r3);
            r4 = (android.support.v7.widget.RecyclerView.ViewHolder) r4;
            r4 = r4.mPosition;
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (RecyclerView.this.mState.isPreLayout()) {
                ...
                obj = changedScrapViewForPosition != null ? 1 : null;
            } else {
            ...
            if (changedScrapViewForPosition == null) {
                ...
                if (changedScrapViewForPosition == null) {
                    ViewCacheExtension viewCacheExtension = recycler.mViewCacheExtension;
                    if (viewCacheExtension != null) {
                        View viewForPositionAndType = viewCacheExtension.getViewForPositionAndType(recycler, i2, itemViewType);
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (!(RecyclerView.this.dispatchNestedScroll(i, i2, i3, i4, null, 1) || (i3 == 0 && i4 == 0))) {
                    ...
                    int i7 = i3 != currX ? i3 < 0 ? -itemCount : i3 > 0 ? itemCount : 0 : 0;
                    if (i4 == currY) {
                        itemCount = 0;
                    } else if (i4 < 0) {
                        itemCount = -itemCount;
    ...
    class C05434 implements ProcessCallback {
        C05434() {
        }
    ...
    class C05445 implements Callback {
        C05445() {
        }
    ...
    class C05456 implements Callback {
        C05456() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C03481();
        Parcelable mLayoutState;

        /* renamed from: android.support.v7.widget.RecyclerView$SavedState$1 */
        static class C03481 implements ClassLoaderCreator<SavedState> {
            C03481() {
            }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C03451();
        ...
        this.mItemAnimatorRunner = new C03462();
        this.mViewInfoProcessCallback = new C05434();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0305R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0305R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0305R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0305R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0305R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0305R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0305R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0305R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            obtainStyledAttributes.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C05445());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C05456());
    }
    ...
    private void setAdapterInternal(@Nullable Adapter adapter, boolean z, boolean z2) {
        ...
        adapter = this.mLayout;
        if (adapter != null) {
            adapter.onAdapterChanged(z2, this.mAdapter);
        }
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (this.mAdapter != null) {
            scrollStep(i8, i9, r7.mScrollStepConsumed);
            int[] iArr = r7.mScrollStepConsumed;
            int i10 = iArr[0];
            i3 = iArr[1];
            i4 = i3;
            i5 = i10;
        ...
        int i11 = i4;
        if (dispatchNestedScroll(i5, i4, i6, i7, r7.mScrollOffset, 0)) {
            i3 = r7.mLastTouchX;
            int[] iArr2 = r7.mScrollOffset;
            r7.mLastTouchX = i3 - iArr2[0];
            r7.mLastTouchY -= iArr2[1];
            if (motionEvent2 != null) {
                motionEvent2.offsetLocation((float) iArr2[0], (float) iArr2[1]);
            }
            iArr = r7.mNestedOffsets;
            i10 = iArr[0];
            int[] iArr3 = r7.mScrollOffset;
            iArr[0] = i10 + iArr3[0];
            iArr[1] = iArr[1] + iArr3[1];
        } else if (getOverScrollMode() != 2) {
            if (!(motionEvent2 == null || MotionEventCompat.isFromSource(motionEvent2, 8194))) {
                pullGlows(motionEvent.getX(), (float) i6, motionEvent.getY(), (float) i7);
            }
            ...
            if (!dispatchNestedPreFling(f, f2)) {
                ...
                if (!canScrollHorizontally) {
                    if (!canScrollVertically) {
                        ...
                        onFlingListener = this.mOnFlingListener;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.mLayoutFrozen) {
            if (!this.mIgnoreMotionEventTillDown) {
                ...
                iArr = this.mNestedOffsets;
                obtain.offsetLocation((float) iArr[0], (float) iArr[1]);
                switch (actionMasked) {
                    case 0:
                        this.mScrollPointerId = motionEvent.getPointerId(0);
                        actionMasked = (int) (motionEvent.getX() + 0.5f);
                    ...
                    case 2:
                        ...
                        if (actionMasked >= 0) {
                            ...
                            int i2 = this.mLastTouchY - motionEvent;
                            if (dispatchNestedPreScroll(actionMasked, i2, this.mScrollConsumed, this.mScrollOffset, 0)) {
                            ...
                            if (this.mScrollState != 1) {
                                ...
                                int i3;
                                if (canScrollHorizontally) {
                                    int abs = Math.abs(actionMasked);
                                    i = this.mTouchSlop;
                                    if (abs > i) {
                                        actionMasked = actionMasked > 0 ? actionMasked - i : actionMasked + i;
                                        obj = 1;
                                        if (canScrollVertically) {
                                            i = Math.abs(i2);
                                            i3 = this.mTouchSlop;
                            ...
                            if (this.mScrollState == 1) {
                                iArr = this.mScrollOffset;
                                this.mLastTouchX = actionIndex - iArr[0];
                                this.mLastTouchY = motionEvent - iArr[1];
                                if (scrollByInternal(canScrollHorizontally ? actionMasked : null, canScrollVertically ? i2 : 0, obtain) != null) {
                                    getParent().requestDisallowInterceptTouchEvent(true);
                                }
                                if (!(this.mGapWorker == null || (actionMasked == 0 && i2 == 0))) {
                                    this.mGapWorker.postFromTraversal(this, actionMasked, i2);
                                    break;
                                }
                            }
                        }
    ...
    public void draw(Canvas canvas) {
        ...
        if (!(edgeEffect == null || edgeEffect.isFinished())) {
            ...
            int i4 = (edgeEffect3 == null || !edgeEffect3.draw(canvas)) ? 0 : 1;
            i |= i4;
            canvas.restoreToCount(size);
        }
        ...
        if (!(edgeEffect == null || edgeEffect.isFinished())) {
            ...
            i4 = (edgeEffect3 == null || !edgeEffect3.draw(canvas)) ? 0 : 1;
            i |= i4;
            canvas.restoreToCount(size);
        }
    ...
    boolean canReuseUpdatedViewHolder(ViewHolder viewHolder) {
        ItemAnimator itemAnimator = this.mItemAnimator;
        if (itemAnimator != null) {
            if (itemAnimator.canReuseUpdatedViewHolder(viewHolder, viewHolder.getUnmodifiedPayloads()) == null) {
                return null;
            }
        }
        return true;
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0305R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0305R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0305R.dimen.fastscroll_margin));
    }
