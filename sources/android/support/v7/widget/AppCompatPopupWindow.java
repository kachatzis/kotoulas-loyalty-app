...
class AppCompatPopupWindow extends PopupWindow {
    ...
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        context = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0291R.styleable.PopupWindow, i, i2);
        if (context.hasValue(C0291R.styleable.PopupWindow_overlapAnchor) != null) {
            setSupportOverlapAnchor(context.getBoolean(C0291R.styleable.PopupWindow_overlapAnchor, 0));
        }
        setBackgroundDrawable(context.getDrawable(C0291R.styleable.PopupWindow_android_popupBackground));
        context.recycle();
    }
