...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03523 implements OnFocusChangeListener {
        C03523() {
        }
    ...
    class C03534 implements OnLayoutChangeListener {
        C03534() {
        }
    ...
    class C03556 implements OnKeyListener {
        C03556() {
        }
        ...
        public boolean onKey(View view, int i, KeyEvent keyEvent) {
            ...
            view.launchQuerySearch(0, 0, view.mSearchSrcTextView.getText().toString());
            return true;
        }
    }

    /* renamed from: android.support.v7.widget.SearchView$7 */
    class C03567 implements OnEditorActionListener {
        C03567() {
        }
    ...
    class C03578 implements OnItemClickListener {
        C03578() {
        }
    ...
    class C03589 implements OnItemSelectedListener {
...
*/
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C03591();
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C03591 implements ClassLoaderCreator<SavedState> {
            C03591() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0291R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            super(context, attributeSet, i);
            this.mRunShowSoftInputIfNecessary = new C03601();
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0291R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C03501();
        this.mReleaseCursorRunnable = new C03512();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03545();
        this.mTextKeyListener = new C03556();
        this.mOnEditorActionListener = new C03567();
        this.mOnItemClickListener = new C03578();
        this.mOnItemSelectedListener = new C03589();
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0291R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(attributeSet.getResourceId(C0291R.styleable.SearchView_layout, C0291R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0291R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0291R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0291R.id.search_plate);
        this.mSubmitArea = findViewById(C0291R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0291R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0291R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0291R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0291R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0291R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, attributeSet.getDrawable(C0291R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, attributeSet.getDrawable(C0291R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(attributeSet.getDrawable(C0291R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(attributeSet.getDrawable(C0291R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(attributeSet.getDrawable(C0291R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(attributeSet.getDrawable(C0291R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(attributeSet.getDrawable(C0291R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = attributeSet.getDrawable(C0291R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0291R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = attributeSet.getResourceId(C0291R.styleable.SearchView_suggestionRowLayout, C0291R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = attributeSet.getResourceId(C0291R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03523());
        setIconifiedByDefault(attributeSet.getBoolean(C0291R.styleable.SearchView_iconifiedByDefault, true));
        context = attributeSet.getDimensionPixelSize(C0291R.styleable.SearchView_android_maxWidth, -1);
        if (context != -1) {
            setMaxWidth(context);
        }
        this.mDefaultQueryHint = attributeSet.getText(C0291R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = attributeSet.getText(C0291R.styleable.SearchView_queryHint);
        context = attributeSet.getInt(C0291R.styleable.SearchView_android_imeOptions, -1);
        if (context != -1) {
            setImeOptions(context);
        }
        context = attributeSet.getInt(C0291R.styleable.SearchView_android_inputType, -1);
        if (context != -1) {
            setInputType(context);
        }
        setFocusable(attributeSet.getBoolean(C0291R.styleable.SearchView_android_focusable, true));
        ...
        if (context != null) {
            context.addOnLayoutChangeListener(new C03534());
        }
    ...
    public void setQueryRefinementEnabled(boolean z) {
        ...
        if (cursorAdapter instanceof SuggestionsAdapter) {
            ((SuggestionsAdapter) cursorAdapter).setQueryRefinement(z ? true : true);
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z) {
            ...
            z = this.mTouchDelegate;
            if (z) {
                z.setBounds(this.mSearchSrtTextViewBoundsExpanded, this.mSearchSrcTextViewBounds);
                return;
            }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0291R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0291R.dimen.abc_search_view_preferred_height);
    }
...
*/
    ...
    L_0x0004:
        return;
    L_0x0005:
        r1 = r0.getVoiceSearchLaunchWebSearch();	 Catch:{ ActivityNotFoundException -> 0x002d }
        if (r1 == 0) goto L_0x0019;	 Catch:{ ActivityNotFoundException -> 0x002d }
    L_0x000b:
        r1 = r2.mVoiceWebSearchIntent;	 Catch:{ ActivityNotFoundException -> 0x002d }
        r0 = r2.createVoiceWebSearchIntent(r1, r0);	 Catch:{ ActivityNotFoundException -> 0x002d }
        r1 = r2.getContext();	 Catch:{ ActivityNotFoundException -> 0x002d }
        r1.startActivity(r0);	 Catch:{ ActivityNotFoundException -> 0x002d }
        goto L_0x0034;	 Catch:{ ActivityNotFoundException -> 0x002d }
    L_0x0019:
        r1 = r0.getVoiceSearchLaunchRecognizer();	 Catch:{ ActivityNotFoundException -> 0x002d }
        if (r1 == 0) goto L_0x0034;	 Catch:{ ActivityNotFoundException -> 0x002d }
    L_0x001f:
        r1 = r2.mVoiceAppSearchIntent;	 Catch:{ ActivityNotFoundException -> 0x002d }
        r0 = r2.createVoiceAppSearchIntent(r1, r0);	 Catch:{ ActivityNotFoundException -> 0x002d }
        r1 = r2.getContext();	 Catch:{ ActivityNotFoundException -> 0x002d }
        r1.startActivity(r0);	 Catch:{ ActivityNotFoundException -> 0x002d }
        goto L_0x0034;
    L_0x002d:
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0291R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0291R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    boolean onItemClicked(int i, int i2, String str) {
        i2 = this.mOnSuggestionListener;
        if (i2 != 0) {
            if (i2.onSuggestionClick(i) != 0) {
                return false;
            }
        }
...
*/
        ...
        r8 = this;
        r0 = 0;
        r1 = "suggest_intent_action";	 Catch:{ RuntimeException -> 0x0063 }
        r1 = android.support.v7.widget.SuggestionsAdapter.getColumnString(r9, r1);	 Catch:{ RuntimeException -> 0x0063 }
        if (r1 != 0) goto L_0x000f;	 Catch:{ RuntimeException -> 0x0063 }
    L_0x0009:
        r1 = r8.mSearchable;	 Catch:{ RuntimeException -> 0x0063 }
        r1 = r1.getSuggestIntentAction();	 Catch:{ RuntimeException -> 0x0063 }
    L_0x000f:
        if (r1 != 0) goto L_0x0015;	 Catch:{ RuntimeException -> 0x0063 }
    L_0x0011:
        r1 = "android.intent.action.SEARCH";	 Catch:{ RuntimeException -> 0x0063 }
        r2 = r1;	 Catch:{ RuntimeException -> 0x0063 }
        goto L_0x0016;	 Catch:{ RuntimeException -> 0x0063 }
    L_0x0015:
        r2 = r1;	 Catch:{ RuntimeException -> 0x0063 }
    L_0x0016:
        r1 = "suggest_intent_data";	 Catch:{ RuntimeException -> 0x0063 }
        r1 = android.support.v7.widget.SuggestionsAdapter.getColumnString(r9, r1);	 Catch:{ RuntimeException -> 0x0063 }
        if (r1 != 0) goto L_0x0024;	 Catch:{ RuntimeException -> 0x0063 }
    L_0x001e:
        r1 = r8.mSearchable;	 Catch:{ RuntimeException -> 0x0063 }
        r1 = r1.getSuggestIntentData();	 Catch:{ RuntimeException -> 0x0063 }
    L_0x0024:
        if (r1 == 0) goto L_0x0046;	 Catch:{ RuntimeException -> 0x0063 }
    L_0x0026:
        r3 = "suggest_intent_data_id";	 Catch:{ RuntimeException -> 0x0063 }
        r3 = android.support.v7.widget.SuggestionsAdapter.getColumnString(r9, r3);	 Catch:{ RuntimeException -> 0x0063 }
        if (r3 == 0) goto L_0x0046;	 Catch:{ RuntimeException -> 0x0063 }
    L_0x002e:
        r4 = new java.lang.StringBuilder;	 Catch:{ RuntimeException -> 0x0063 }
        r4.<init>();	 Catch:{ RuntimeException -> 0x0063 }
        r4.append(r1);	 Catch:{ RuntimeException -> 0x0063 }
        r1 = "/";	 Catch:{ RuntimeException -> 0x0063 }
        r4.append(r1);	 Catch:{ RuntimeException -> 0x0063 }
        r1 = android.net.Uri.encode(r3);	 Catch:{ RuntimeException -> 0x0063 }
        r4.append(r1);	 Catch:{ RuntimeException -> 0x0063 }
        r1 = r4.toString();	 Catch:{ RuntimeException -> 0x0063 }
    L_0x0046:
        if (r1 != 0) goto L_0x004a;	 Catch:{ RuntimeException -> 0x0063 }
    L_0x0048:
        r3 = r0;	 Catch:{ RuntimeException -> 0x0063 }
        goto L_0x004f;	 Catch:{ RuntimeException -> 0x0063 }
    L_0x004a:
        r1 = android.net.Uri.parse(r1);	 Catch:{ RuntimeException -> 0x0063 }
        r3 = r1;	 Catch:{ RuntimeException -> 0x0063 }
    L_0x004f:
        r1 = "suggest_intent_query";	 Catch:{ RuntimeException -> 0x0063 }
        r5 = android.support.v7.widget.SuggestionsAdapter.getColumnString(r9, r1);	 Catch:{ RuntimeException -> 0x0063 }
        r1 = "suggest_intent_extra_data";	 Catch:{ RuntimeException -> 0x0063 }
        r4 = android.support.v7.widget.SuggestionsAdapter.getColumnString(r9, r1);	 Catch:{ RuntimeException -> 0x0063 }
        r1 = r8;	 Catch:{ RuntimeException -> 0x0063 }
        r6 = r10;	 Catch:{ RuntimeException -> 0x0063 }
        r7 = r11;	 Catch:{ RuntimeException -> 0x0063 }
        r9 = r1.createIntent(r2, r3, r4, r5, r6, r7);	 Catch:{ RuntimeException -> 0x0063 }
        return r9;
    L_0x0063:
        r10 = move-exception;
        r9 = r9.getPosition();	 Catch:{ RuntimeException -> 0x0069 }
        goto L_0x006a;
    L_0x0069:
        r9 = -1;
    L_0x006a:
