...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0291R.styleable.ButtonBarLayout);
        this.mAllowStacking = context.getBoolean(C0291R.styleable.ButtonBarLayout_allowStacking, true);
        context.recycle();
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (i >= 0) {
            ...
            if (isStacked() != 0) {
                ...
                i3 = i >= 0 ? paddingTop + (getChildAt(i).getPaddingTop() + ((int) (getResources().getDisplayMetrics().density * 1098907648))) : paddingTop;
            } else {
    ...
    private void setStacked(boolean z) {
        setOrientation(z);
        setGravity(z ? 5 : 80);
        View findViewById = findViewById(C0291R.id.spacer);
