    ...
    public void runPendingAnimations() {
        ...
        if (isEmpty != 0 || isEmpty2 != 0 || isEmpty4 != 0 || isEmpty3 != 0) {
            ...
            if (isEmpty2 != 0) {
                ...
                if (isEmpty != 0) {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) arrayList.get(0)).holder.itemView, c03311, getRemoveDuration());
                } else {
                    c03311.run();
                }
            }
            if (isEmpty3 != 0) {
                ...
                if (isEmpty != 0) {
                    ViewCompat.postOnAnimationDelayed(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, c03311, getRemoveDuration());
                } else {
                    c03311.run();
                }
            }
            if (isEmpty4 != 0) {
                ...
                ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList2.get(0)).itemView, c03333, removeDuration + Math.max(moveDuration, j));
            }
        }
    }
