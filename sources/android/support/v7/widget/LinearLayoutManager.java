...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler, ScrollVectorProvider {
    ...
    static class LayoutState {
        ...
        boolean hasMore(State state) {
            ...
            return (i < 0 || i >= state.getItemCount()) ? null : true;
        }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C03411();
        boolean mAnchorLayoutFromEnd;
        int mAnchorOffset;
        int mAnchorPosition;

        /* renamed from: android.support.v7.widget.LinearLayoutManager$SavedState$1 */
        static class C03411 implements Creator<SavedState> {
            C03411() {
            }
    ...
    public void onLayoutChildren(Recycler recycler, State state) {
            ...
            if (this.mPendingSavedState == null) {
                ...
                if (state.isPreLayout()) {
                    ...
                    if (!(i3 == -1 || this.mPendingScrollPositionOffset == Integer.MIN_VALUE)) {
                        findViewByPosition = findViewByPosition(i3);
        ...
        if (this.mAnchorInfo.mLayoutFromEnd) {
            ...
            if (this.mLayoutState.mAvailable > 0) {
                i3 = this.mLayoutState.mAvailable;
                updateLayoutStateToFillStart(i, extraLayoutSpace);
                LayoutState layoutState32 = this.mLayoutState;
                layoutState32.mExtra = i3;
                fill(recycler, layoutState32, state, false);
                extraLayoutSpace = this.mLayoutState.mOffset;
            }
        }
        if (getChildCount() > 0) {
            ...
            if (i != -1) {
                if (i >= 0) {
                    if (i < state.getItemCount()) {
                        ...
                        if (state != null && state.hasValidAnchor() != null) {
                            ...
                            state = this.mShouldReverseLayout;
                            anchorInfo.mLayoutFromEnd = state;
                            if (state != null) {
    ...
    private void updateLayoutStateToFillStart(int i, int i2) {
        ...
        LayoutState layoutState = this.mLayoutState;
        layoutState.mCurrentPosition = i;
        layoutState.mItemDirection = this.mShouldReverseLayout != 0 ? 1 : -1;
        i = this.mLayoutState;
        i.mLayoutDirection = -1;
        i.mOffset = i2;
        i.mScrollingOffset = Integer.MIN_VALUE;
    }
    ...
    private void updateLayoutState(int i, int i2, boolean z, State state) {
        ...
        int i3 = -1;
        if (i == 1) {
            state.mExtra += this.mOrientationHelper.getEndPadding();
            i = getChildClosestToEnd();
            state = this.mLayoutState;
            if (!this.mShouldReverseLayout) {
                i3 = 1;
            }
            state.mItemDirection = i3;
            ...
            state = this.mLayoutState;
            state.mExtra += this.mOrientationHelper.getStartAfterPadding();
            state = this.mLayoutState;
            if (this.mShouldReverseLayout) {
                i3 = 1;
            }
    ...
    public View onFocusSearchFailed(View view, int i, Recycler recycler, State state) {
        ...
        fill(recycler, layoutState, state, 1);
        if (view == -1) {
