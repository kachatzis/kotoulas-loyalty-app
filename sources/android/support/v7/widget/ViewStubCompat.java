...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0291R.styleable.ViewStubCompat, i, 0);
        this.mInflatedId = context.getResourceId(C0291R.styleable.ViewStubCompat_android_inflatedId, -1);
        this.mLayoutResource = context.getResourceId(C0291R.styleable.ViewStubCompat_android_layout, 0);
        setId(context.getResourceId(C0291R.styleable.ViewStubCompat_android_id, -1));
        context.recycle();
        setVisibility(8);
        setWillNotDraw(true);
    }
