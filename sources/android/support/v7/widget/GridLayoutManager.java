...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void setMeasuredDimension(Rect rect, int i, int i2) {
        ...
        if (this.mOrientation == 1) {
            ...
            i2 = this.mCachedBorders;
            i = LayoutManager.chooseSize(i, i2[i2.length - 1] + paddingLeft, getMinimumWidth());
        } else {
            i = LayoutManager.chooseSize(i, rect.width() + paddingLeft, getMinimumWidth());
            rect = this.mCachedBorders;
            rect = LayoutManager.chooseSize(i2, rect[rect.length - 1] + paddingTop, getMinimumHeight());
        }
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        int i3 = getChildCount() > 0 ? r6.mCachedBorders[r6.mSpanCount] : 0;
        if (obj != null) {
            updateMeasurements();
        }
        ...
        float f = 0.0f;
        int i6 = i2;
        assignSpans(recycler, state, i2, i, z);
        int i7 = 0;
        for (i4 = 0; i4 < i6; i4++) {
            boolean z2;
            View view = r6.mSet[i4];
        ...
        for (i4 = 0; i4 < i6; i4++) {
            ...
            if (r6.mOrientationHelper.getDecoratedMeasurement(view) != i7) {
                ...
                if (r6.mOrientation == 1) {
                    i5 = LayoutManager.getChildMeasureSpec(i, 1073741824, modeInOther, layoutParams.width, false);
                    i = MeasureSpec.makeMeasureSpec(i7 - i2, 1073741824);
                } else {
                    modeInOther = MeasureSpec.makeMeasureSpec(i7 - modeInOther, 1073741824);
                    i = LayoutManager.getChildMeasureSpec(i, 1073741824, i2, layoutParams.height, false);
                    i5 = modeInOther;
                }
                measureChildWithDecorationsAndMargin(view, i5, i, true);
            }
        }
        spanSize = 0;
        ...
        while (spanSize < i6) {
            ...
            if (r6.mOrientation != 1) {
                ...
                decoratedMeasurementInOther2 = r6.mOrientationHelper.getDecoratedMeasurementInOther(view2) + decoratedMeasurement;
            } else if (isLayoutRTL()) {
                i4 = getPaddingLeft() + r6.mCachedBorders[r6.mSpanCount - layoutParams2.mSpanIndex];
                i10 = i4;
                i9 = i4 - r6.mOrientationHelper.getDecoratedMeasurementInOther(view2);
                i3 = decoratedMeasurement;
                decoratedMeasurementInOther2 = i5;
            } else {
                i4 = getPaddingLeft() + r6.mCachedBorders[layoutParams2.mSpanIndex];
                i9 = i4;
                i10 = r6.mOrientationHelper.getDecoratedMeasurementInOther(view2) + i4;
                i3 = decoratedMeasurement;
                decoratedMeasurementInOther2 = i5;
            }
            layoutDecoratedWithMargins(view2, i9, i3, i10, decoratedMeasurementInOther2);
            ...
            if (!childAt.hasFocusable() || spanGroupIndex2 == spanGroupIndex) {
                ...
                if (obj != null) {
                    if (childAt.hasFocusable()) {
                        ...
                        i6 = Math.min(i13, i3) - Math.max(i12, i2);
                    }
                    childCount += i5;
                    i8 = i6;
