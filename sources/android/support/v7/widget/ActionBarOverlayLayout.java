...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static final int[] ATTRS = new int[]{C0291R.attr.actionBarSize, 16842841};
    ...
    class C03201 extends AnimatorListenerAdapter {
        C03201() {
        }

        public void onAnimationEnd(Animator animator) {
            animator = ActionBarOverlayLayout.this;
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C03201();
        this.mRemoveActionBarHideOffset = new C03212();
        this.mAddActionBarHideOffset = new C03223();
        init(context);
    ...
    public void setActionBarVisibilityCallback(ActionBarVisibilityCallback actionBarVisibilityCallback) {
        ...
        if (getWindowToken() != null) {
            ...
            actionBarVisibilityCallback = this.mLastSystemUiVisibility;
            if (actionBarVisibilityCallback != null) {
                onWindowSystemUiVisibilityChanged(actionBarVisibilityCallback);
    ...
    public void onWindowSystemUiVisibilityChanged(int i) {
        ...
        i = this.mActionBarVisibilityCallback;
        if (i != 0) {
            i.enableContentAnimations(i3 ^ 1);
            if (obj == null) {
                if (i3 != 0) {
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0291R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0291R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0291R.id.action_bar));
        }
    }
