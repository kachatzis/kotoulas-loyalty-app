...
public final class CircularRevealCompat {
    ...
    public static Animator createCircularReveal(CircularRevealWidget circularRevealWidget, float f, float f2, float f3) {
        ...
        if (revealInfo != null) {
            circularRevealWidget = ViewAnimationUtils.createCircularReveal((View) circularRevealWidget, (int) f, (int) f2, revealInfo.radius, f3);
            f = new AnimatorSet();
            f.playTogether(new Animator[]{ofObject, circularRevealWidget});
            return f;
        }
    ...
    public static Animator createCircularReveal(CircularRevealWidget circularRevealWidget, float f, float f2, float f3, float f4) {
        ...
        circularRevealWidget = ViewAnimationUtils.createCircularReveal((View) circularRevealWidget, (int) f, (int) f2, f3, f4);
        f = new AnimatorSet();
        f.playTogether(new Animator[]{ofObject, circularRevealWidget});
        return f;
    }
