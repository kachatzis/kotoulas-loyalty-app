...
public class CircularRevealHelper {
    ...
    public RevealInfo getRevealInfo() {
        RevealInfo revealInfo = this.revealInfo;
        if (revealInfo == null) {
            return null;
        }
        RevealInfo revealInfo2 = new RevealInfo(revealInfo);
    ...
    private void invalidateRevealInfo() {
        if (STRATEGY == 1) {
            ...
            RevealInfo revealInfo = this.revealInfo;
            if (revealInfo != null) {
                this.revealPath.addCircle(revealInfo.centerX, this.revealInfo.centerY, this.revealInfo.radius, Direction.CW);
            }
        }
        this.view.invalidate();
    }
