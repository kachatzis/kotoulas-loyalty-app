...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:31:0x0082 in {6, 8, 16, 18, 21, 22, 24, 28, 30} preds:[]
...
*/
        ...
        L_0x001a:
            ...
            r6 = "View can not be anchored to the the parent CoordinatorLayout";
            r5.<init>(r6);
            throw r5;
        L_0x0022:
            r2 = r0.getParent();
        ...
        L_0x0037:
            r5 = new java.lang.IllegalStateException;
            r6 = "Anchor must not be a descendant of the anchored view";
            r5.<init>(r6);
            throw r5;
        L_0x003f:
        ...
        boolean isBlockingInteractionBelow(CoordinatorLayout coordinatorLayout, View view) {
            ...
            coordinatorLayout = (behavior != null ? behavior.blocksInteractionBelow(coordinatorLayout, view) : null) | z;
        ...
        boolean dependsOn(CoordinatorLayout coordinatorLayout, View view, View view2) {
            if (!(view2 == this.mAnchorDirectChild || shouldDodge(view2, ViewCompat.getLayoutDirection(coordinatorLayout)))) {
                Behavior behavior = this.mBehavior;
                if (behavior == null || behavior.layoutDependsOn(coordinatorLayout, view, view2) == null) {
                    return null;
                }
            }
            return true;
    ...
    class C04721 implements OnApplyWindowInsetsListener {
        C04721() {
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        Behavior behavior = ((LayoutParams) r0.mBehaviorTouchView.getLayoutParams()).getBehavior();
        z = behavior != null ? behavior.onTouchEvent(r0, r0.mBehaviorTouchView, motionEvent3) : false;
        motionEvent2 = null;
        if (r0.mBehaviorTouchView == null) {
            z |= super.onTouchEvent(motionEvent);
        } else if (performIntercept) {
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C04721();
                }
