...
public class AppBarLayout extends LinearLayout {
    ...
    class C04581 implements OnApplyWindowInsetsListener {
        C04581() {
        }
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout, final T t, int i, int i2) {
            if (getTopBottomOffsetForScrollingSibling() == i) {
                ...
                if (!(coordinatorLayout == null || coordinatorLayout.isRunning() == null)) {
        ...
        boolean canDragView(T t) {
            ...
            t = this.lastNestedScrollingChildRef;
            boolean z = true;
            if (t == null) {
                return true;
            }
            View view = (View) t.get();
            ...
            if (appBarChildOnOffset != null) {
                ...
                if ((scrollFlags & 1) != 0) {
                    ...
                    if (i2 > 0 && (scrollFlags & 12) != 0) {
                        i = (-i) >= (appBarChildOnOffset.getBottom() - minimumHeight) - t.getTopInset() ? 1 : 0;
                        if (t.isLiftOnScroll() != 0) {
                            i2 = findFirstScrollingChild(coordinatorLayout);
                            if (i2 != 0) {
                                if (i2.getScrollY() > 0) {
                                }
                            }
                        }
                        i = t.setLiftedState(i);
                        ...
                        if (t.isLiftOnScroll() != 0) {
                            i2 = findFirstScrollingChild(coordinatorLayout);
                            if (i2 != 0) {
                                i = i2.getScrollY() > 0 ? 1 : 0;
                            }
                        }
                        i = t.setLiftedState(i);
                        if (VERSION.SDK_INT >= 11) {
                        }
                        if (z || !(i == 0 || shouldJumpElevationState(coordinatorLayout, t) == null)) {
                            t.jumpDrawablesToCurrentState();
                        }
                        return;
                    }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        context.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new C04581());
    }
        ...
        for (i = getChildCount() - 1; i >= 0; i--) {
            ...
            if ((i3 & 5) == 5) {
                ...
                if ((i3 & 8) != 0) {
                    ...
                    i2 += measuredHeight - ViewCompat.getMinimumHeight(childAt);
                } else {
                    i2 += measuredHeight - getTopInset();
                }
            } else if (i2 > 0) {
                break;
            }
