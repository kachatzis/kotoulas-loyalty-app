...
*/
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (VERSION.SDK_INT >= 11) {
            i4 = resolveSizeAndState(size, i4, mode << 16) & ViewCompat.MEASURED_SIZE_MASK;
            i3 = Math.min(r0.mMaxWidth, resolveSizeAndState(i3, i, mode) & ViewCompat.MEASURED_SIZE_MASK);
