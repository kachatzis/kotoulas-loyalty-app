...
public class ConstraintWidget {
    ...
    public void reset() {
        ...
        iArr[0] = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
        iArr[1] = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
...
*/
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (constraintWidget3 != null) {
            ...
            boolean z8 = constraintWidget4 != null && constraintWidget4.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
            if (isChainHead(0)) {
            ...
            if (z8 && constraintWidget.mVisibility != 8 && constraintWidget.mTop.mTarget == null && constraintWidget.mBottom.mTarget == null && constraintWidget.mBaseline == null) {
        ...
        if (obj != null) {
            ...
            z6 = true;
            z10 = constraintWidget.mListDimensionBehaviors[0] != DimensionBehaviour.WRAP_CONTENT && (constraintWidget instanceof ConstraintWidgetContainer);
                ...
                if (obj != null) {
                    ...
                    if (i11 == 1 || i11 == -1) {
                        ...
                        if (constraintWidget.mBaselineDistance <= 0) {
                            createObjectVariable4 = solverVariable2;
                            ...
                            createObjectVariable4 = solverVariable2;
                            linearSystem3.addEquality(solverVariable3, createObjectVariable4, getBaselineDistance(), 6);
                            if (constraintWidget.mBaseline.mTarget != null) {
                                linearSystem3.addEquality(solverVariable3, linearSystem3.createObjectVariable(constraintWidget.mBaseline.mTarget), 0, 6);
                                z13 = false;
                                constraintWidget3 = constraintWidget.mParent;
                                createObjectVariable6 = constraintWidget3 == null ? linearSystem3.createObjectVariable(constraintWidget3.mBottom) : null;
                                constraintWidget3 = constraintWidget.mParent;
                                solverVariable6 = createObjectVariable4;
                                applyConstraints(linearSystem, z11, constraintWidget3 == null ? linearSystem3.createObjectVariable(constraintWidget3.mTop) : null, createObjectVariable6, constraintWidget.mListDimensionBehaviors[1], z12, constraintWidget.mTop, constraintWidget.mBottom, constraintWidget.mY, i3, constraintWidget.mMinHeight, constraintWidget.mMaxDimension[1], constraintWidget.mVerticalBiasPercent, z4, z5, i4, constraintWidget.mMatchConstraintMinHeight, constraintWidget.mMatchConstraintMaxHeight, constraintWidget.mMatchConstraintPercentHeight, z13);
                                if (obj == null) {
                                    constraintWidget2 = this;
                                } else if (this.mResolvedDimensionRatioSide != 1) {
                                    linearSystem.addRatio(solverVariable, solverVariable6, solverVariable5, createObjectVariable, constraintWidget2.mResolvedDimensionRatio, 6);
                                } else {
                                    linearSystem.addRatio(solverVariable5, createObjectVariable, solverVariable, solverVariable6, constraintWidget2.mResolvedDimensionRatio, 6);
                                }
