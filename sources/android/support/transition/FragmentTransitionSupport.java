    ...
    public void scheduleRemoveTargets(Object obj, Object obj2, ArrayList<View> arrayList, Object obj3, ArrayList<View> arrayList2, Object obj4, ArrayList<View> arrayList3) {
        ...
        ((Transition) obj).addListener(new TransitionListener() {
            ...
            public void onTransitionStart(@NonNull Transition transition) {
                transition = obj5;
                if (transition != null) {
                    FragmentTransitionSupport.this.replaceTargets(transition, arrayList4, null);
                }
                transition = obj6;
                if (transition != null) {
                    FragmentTransitionSupport.this.replaceTargets(transition, arrayList5, null);
                }
                transition = obj7;
                if (transition != null) {
                    FragmentTransitionSupport.this.replaceTargets(transition, arrayList6, null);
                }
            }
        });
    }
