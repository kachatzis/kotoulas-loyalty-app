...
public class Explode extends Visibility {
    ...
    public Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        viewGroup = this.mTempLoc;
        return TranslationAnimationCreator.createAnimation(view, transitionValues2, rect.left, rect.top, translationX + ((float) viewGroup[0]), translationY + ((float) viewGroup[1]), translationX, translationY, sDecelerate);
    }
    ...
    public Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        float translationX = view.getTranslationX();
        float translationY = view.getTranslationY();
        int[] iArr = (int[]) transitionValues.view.getTag(C0116R.id.transition_position);
        if (iArr != null) {
        ...
        calculateOut(viewGroup, rect, this.mTempLoc);
        viewGroup = this.mTempLoc;
        return TranslationAnimationCreator.createAnimation(view, transitionValues, i, i2, translationX, translationY, f + ((float) viewGroup[0]), f2 + ((float) viewGroup[1]), sAccelerate);
    }
