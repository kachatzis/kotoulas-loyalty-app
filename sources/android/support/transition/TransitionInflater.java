            ...
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                if (next == 2) {
                    ...
                    if ("fade".equals(name)) {
                        ...
                        transition.append("Unknown scene name: ");
        ...
        while (true) {
            ...
            if (next == 2) {
                if (xmlPullParser.getName().equals("target")) {
                                ...
                                if (namedString != null) {
                                    ...
                                    if (namedString2 != null) {
                                        try {
                                            ...
                                            transition = new StringBuilder();
                                            transition.append("Could not create ");
                                            transition.append(namedString2);
                                            throw new RuntimeException(transition.toString(), xmlPullParser2);
                                        }
                                    }
                                    namedString2 = TypedArrayUtils.getNamedString(obtainStyledAttributes, xmlPullParser2, "targetClass", 0);
                                    if (namedString2 != null) {
                    ...
                    transition = new StringBuilder();
                    transition.append("Unknown scene name: ");
                    transition.append(xmlPullParser2.getName());
                    throw new RuntimeException(transition.toString());
                }
            }
        }
        ...
        if (namedResourceId >= 0) {
            ...
            if (xmlPullParser != null) {
                if (scene2 == null) {
                    ...
                    xmlPullParser.append("No toScene for transition ID ");
