...
public class ChangeTransform extends Transition {
    ...
    private static class PathAnimatorMatrix {
        ...
        PathAnimatorMatrix(View view, float[] fArr) {
            ...
            view = this.mValues;
            this.mTranslationX = view[2];
            this.mTranslationY = view[5];
            setAnimationMatrix();
        }
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(@NonNull Transition transition) {
            ...
            this.mView.setTag(C0116R.id.transition_transform, null);
            this.mView.setTag(C0116R.id.parent_matrix, null);
        }
            ...
            if (matrix2 != null) {
                if (!matrix2.isIdentity()) {
                    ...
                    if (this.mReparent) {
                        ...
                        transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0116R.id.transition_transform));
                        transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0116R.id.parent_matrix));
                    }
                }
            }
            matrix = null;
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, boolean z) {
        ...
        final Matrix matrix2 = matrix == null ? MatrixUtils.IDENTITY_MATRIX : matrix;
        ...
        final boolean z2 = z;
        TransitionValues c01123 = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (this.mIsCanceled == null) {
                    if (z2 == null || ChangeTransform.this.mUseOverlay == null) {
                        view.setTag(C0116R.id.transition_transform, null);
                        view.setTag(C0116R.id.parent_matrix, null);
                    } else {
            ...
            private void setCurrentMatrix(Matrix matrix) {
                ...
                view.setTag(C0116R.id.transition_transform, this.mTempMatrix);
                transforms.restore(view);
            }
        };
        transitionValues.addListener(c01123);
        AnimatorUtils.addPauseListener(transitionValues, c01123);
    ...
    private void setMatricesForParent(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transitionValues2.view.setTag(C0116R.id.parent_matrix, matrix);
