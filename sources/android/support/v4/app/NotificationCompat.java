...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder setLights(@ColorInt int i, int i2, int i3) {
            ...
            i2 = this.mNotification;
            i2.flags = i | (i2.flags & -2);
            return this;
        }
...
*/
    ...
    static Action getActionCompatFromAction(android.app.Notification.Action action) {
        ...
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, null, z, semanticAction, z3);
    }
