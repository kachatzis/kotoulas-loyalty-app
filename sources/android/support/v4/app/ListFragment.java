...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01532();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01521();
    ...
    class C01532 implements OnItemClickListener {
        C01532() {
        }
