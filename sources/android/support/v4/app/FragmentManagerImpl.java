...
final class FragmentManagerImpl extends FragmentManager implements Factory2 {
    ...
    int mCurState = 0;
    boolean mDestroyed;
    Runnable mExecCommit = new C01321();
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:18:0x003f in {6, 9, 12, 14, 17} preds:[]
...
*/
        ...
        if (r0 == 0) goto L_0x003a;	 Catch:{ all -> 0x003c }
    L_0x0006:
        r0 = r4.mPendingActions;	 Catch:{ all -> 0x003c }
        r0 = r0.size();	 Catch:{ all -> 0x003c }
        if (r0 != 0) goto L_0x000f;	 Catch:{ all -> 0x003c }
    L_0x000e:
        goto L_0x003a;	 Catch:{ all -> 0x003c }
    L_0x000f:
        r0 = r4.mPendingActions;	 Catch:{ all -> 0x003c }
        r0 = r0.size();	 Catch:{ all -> 0x003c }
        r2 = 0;	 Catch:{ all -> 0x003c }
    L_0x0016:
        if (r1 >= r0) goto L_0x0028;	 Catch:{ all -> 0x003c }
    L_0x0018:
        ...
        r2 = r2 | r3;	 Catch:{ all -> 0x003c }
        r1 = r1 + 1;	 Catch:{ all -> 0x003c }
        goto L_0x0016;	 Catch:{ all -> 0x003c }
    L_0x0028:
        ...
        return r2;	 Catch:{ all -> 0x003c }
    L_0x003a:
        monitor-exit(r4);	 Catch:{ all -> 0x003c }
        return r1;	 Catch:{ all -> 0x003c }
    L_0x003c:
        r5 = move-exception;	 Catch:{ all -> 0x003c }
        monitor-exit(r4);	 Catch:{ all -> 0x003c }
        throw r5;
        return;
        */
    ...
    public void dump(java.lang.String r7, java.io.FileDescriptor r8, java.io.PrintWriter r9, java.lang.String[] r10) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:65:0x020e in {8, 9, 14, 21, 28, 37, 42, 50, 53, 56, 59, 60, 64} preds:[]
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.computeDominators(BlockProcessor.java:129)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.processBlocksTree(BlockProcessor.java:48)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.visit(BlockProcessor.java:38)
	at jadx.core.dex.visitors.DepthTraversal.visit(DepthTraversal.java:31)
...
*/
    ...
    L_0x00db:
        r4 = r6.mBackStack;
        r4 = r4.get(r3);
        r4 = (android.support.v4.app.BackStackRecord) r4;
        r9.print(r7);
        r5 = "  #";
        r9.print(r5);
        r9.print(r3);
    ...
    L_0x0100:
        monitor-enter(r6);
        r8 = r6.mBackStackIndices;	 Catch:{ all -> 0x020b }
        if (r8 == 0) goto L_0x0136;	 Catch:{ all -> 0x020b }
    L_0x0105:
        r8 = r6.mBackStackIndices;	 Catch:{ all -> 0x020b }
        r8 = r8.size();	 Catch:{ all -> 0x020b }
        if (r8 <= 0) goto L_0x0136;	 Catch:{ all -> 0x020b }
    L_0x010d:
        r9.print(r7);	 Catch:{ all -> 0x020b }
        r10 = "Back Stack Indices:";	 Catch:{ all -> 0x020b }
        r9.println(r10);	 Catch:{ all -> 0x020b }
        r10 = 0;	 Catch:{ all -> 0x020b }
    L_0x0116:
        if (r10 >= r8) goto L_0x0136;	 Catch:{ all -> 0x020b }
    L_0x0118:
        r0 = r6.mBackStackIndices;	 Catch:{ all -> 0x020b }
        r0 = r0.get(r10);	 Catch:{ all -> 0x020b }
        r0 = (android.support.v4.app.BackStackRecord) r0;	 Catch:{ all -> 0x020b }
        r9.print(r7);	 Catch:{ all -> 0x020b }
        r1 = "  #";	 Catch:{ all -> 0x020b }
        ...
        r10 = r10 + 1;	 Catch:{ all -> 0x020b }
        goto L_0x0116;	 Catch:{ all -> 0x020b }
    L_0x0136:
        r8 = r6.mAvailBackStackIndices;	 Catch:{ all -> 0x020b }
        if (r8 == 0) goto L_0x0157;	 Catch:{ all -> 0x020b }
    L_0x013a:
        r8 = r6.mAvailBackStackIndices;	 Catch:{ all -> 0x020b }
        r8 = r8.size();	 Catch:{ all -> 0x020b }
        if (r8 <= 0) goto L_0x0157;	 Catch:{ all -> 0x020b }
    L_0x0142:
        r9.print(r7);	 Catch:{ all -> 0x020b }
        r8 = "mAvailBackStackIndices: ";	 Catch:{ all -> 0x020b }
        r9.print(r8);	 Catch:{ all -> 0x020b }
        r8 = r6.mAvailBackStackIndices;	 Catch:{ all -> 0x020b }
        r8 = r8.toArray();	 Catch:{ all -> 0x020b }
        r8 = java.util.Arrays.toString(r8);	 Catch:{ all -> 0x020b }
        r9.println(r8);	 Catch:{ all -> 0x020b }
    L_0x0157:
        monitor-exit(r6);	 Catch:{ all -> 0x020b }
        r8 = r6.mPendingActions;
    ...
    L_0x016c:
        r10 = r6.mPendingActions;
        r10 = r10.get(r2);
        r10 = (android.support.v4.app.FragmentManagerImpl.OpGenerator) r10;
        r9.print(r7);
        r0 = "  #";
        r9.print(r0);
        r9.print(r2);
    ...
    L_0x01bd:
        ...
        r8 = r6.mDestroyed;
        r9.println(r8);
        r8 = r6.mNeedMenuInvalidate;
        if (r8 == 0) goto L_0x01f9;
    L_0x01ec:
        r9.print(r7);
        r8 = "  mNeedMenuInvalidate=";
        r9.print(r8);
        r8 = r6.mNeedMenuInvalidate;
        r9.println(r8);
    L_0x01f9:
        r8 = r6.mNoTransactionsBecause;
        if (r8 == 0) goto L_0x020a;
    L_0x01fd:
        r9.print(r7);
        r7 = "  mNoTransactionsBecause=";
        r9.print(r7);
        r7 = r6.mNoTransactionsBecause;
        r9.println(r7);
    L_0x020a:
        return;
    L_0x020b:
...
*/
    ...
    L_0x0014:
        r0 = DEBUG;	 Catch:{ all -> 0x009e }
        if (r0 == 0) goto L_0x0036;	 Catch:{ all -> 0x009e }
    L_0x0018:
        r0 = "FragmentManager";	 Catch:{ all -> 0x009e }
        r1 = new java.lang.StringBuilder;	 Catch:{ all -> 0x009e }
        r1.<init>();	 Catch:{ all -> 0x009e }
        r2 = "Setting back stack index ";	 Catch:{ all -> 0x009e }
        r1.append(r2);	 Catch:{ all -> 0x009e }
        r1.append(r5);	 Catch:{ all -> 0x009e }
        r2 = " to ";	 Catch:{ all -> 0x009e }
        r1.append(r2);	 Catch:{ all -> 0x009e }
    ...
    L_0x0079:
        ...
        r1 = new java.lang.StringBuilder;	 Catch:{ all -> 0x009e }
        r1.<init>();	 Catch:{ all -> 0x009e }
        r2 = "Adding back stack index ";	 Catch:{ all -> 0x009e }
        r1.append(r2);	 Catch:{ all -> 0x009e }
        r1.append(r5);	 Catch:{ all -> 0x009e }
        r5 = " with ";	 Catch:{ all -> 0x009e }
        r1.append(r5);	 Catch:{ all -> 0x009e }
        r1.append(r6);	 Catch:{ all -> 0x009e }
        r5 = r1.toString();	 Catch:{ all -> 0x009e }
        android.util.Log.v(r0, r5);	 Catch:{ all -> 0x009e }
    L_0x0097:
        r5 = r4.mBackStackIndices;	 Catch:{ all -> 0x009e }
        r5.add(r6);	 Catch:{ all -> 0x009e }
    L_0x009c:
        monitor-exit(r4);	 Catch:{ all -> 0x009e }
        return;	 Catch:{ all -> 0x009e }
    L_0x009e:
        r5 = move-exception;	 Catch:{ all -> 0x009e }
        monitor-exit(r4);	 Catch:{ all -> 0x009e }
        throw r5;
        return;
        */
...
*/
    ...
    L_0x0018:
        r5 = r4.mLifecycleCallbacks;	 Catch:{ all -> 0x0023 }
        r5.remove(r1);	 Catch:{ all -> 0x0023 }
    ...
    L_0x0023:
        r5 = move-exception;	 Catch:{ all -> 0x0023 }
        monitor-exit(r0);	 Catch:{ all -> 0x0023 }
        throw r5;
        return;
        */
...
*/
    ...
    L_0x0201:
        r1 = r15.getResources();	 Catch:{ NotFoundException -> 0x020c }
        r2 = r7.mContainerId;	 Catch:{ NotFoundException -> 0x020c }
        r1 = r1.getResourceName(r2);	 Catch:{ NotFoundException -> 0x020c }
        goto L_0x020e;
    L_0x020c:
        r1 = "unknown";
    L_0x020e:
    ...
    void moveFragmentToExpectedState(Fragment fragment) {
        if (fragment != null) {
            ...
            int min = fragment.mRemoving ? fragment.isInBackStack() ? Math.min(i, 1) : Math.min(i, 0) : i;
            moveToState(fragment, min, fragment.getNextTransition(), fragment.getNextTransitionStyle(), false);
            if (fragment.mView != null) {
    ...
    void moveToState(int i, boolean z) {
        ...
        if (z || i != this.mCurState) {
            ...
            if (this.mActive != 0) {
                ...
                if (this.mNeedMenuInvalidate != 0) {
                    i = this.mHost;
                    if (i != 0 && this.mCurState == 4) {
                        i.onSupportInvalidateOptionsMenu();
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (!Fragment.isSupportFragmentClass(fragmentManagerImpl.mHost.getContext(), string)) {
            return null;
        }
        Fragment fragment;
        if (view != null) {
        ...
        if (findFragmentById == null) {
            Fragment instantiate = fragmentManagerImpl.mContainer.instantiate(context2, string, null);
