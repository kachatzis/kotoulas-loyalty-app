...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:27:0x0064 in {2, 5, 11, 16, 20, 21, 23, 26} preds:[]
...
*/
            /*
            r6 = this;
            r0 = r6.mViewsContainingListeners;
            if (r0 == 0) goto L_0x0007;
        L_0x0004:
            r0.clear();
        L_0x0007:
            r0 = sViewsWithListeners;
            r0 = r0.isEmpty();
        ...
        L_0x0010:
            r0 = sViewsWithListeners;
            monitor-enter(r0);
            r1 = r6.mViewsContainingListeners;	 Catch:{ all -> 0x0061 }
            if (r1 != 0) goto L_0x001e;	 Catch:{ all -> 0x0061 }
        L_0x0017:
            r1 = new java.util.WeakHashMap;	 Catch:{ all -> 0x0061 }
            r1.<init>();	 Catch:{ all -> 0x0061 }
            r6.mViewsContainingListeners = r1;	 Catch:{ all -> 0x0061 }
        L_0x001e:
            r1 = sViewsWithListeners;	 Catch:{ all -> 0x0061 }
            r1 = r1.size();	 Catch:{ all -> 0x0061 }
            r1 = r1 + -1;	 Catch:{ all -> 0x0061 }
        L_0x0026:
            if (r1 < 0) goto L_0x005f;	 Catch:{ all -> 0x0061 }
        L_0x0028:
            r2 = sViewsWithListeners;	 Catch:{ all -> 0x0061 }
            r2 = r2.get(r1);	 Catch:{ all -> 0x0061 }
            r2 = (java.lang.ref.WeakReference) r2;	 Catch:{ all -> 0x0061 }
            r2 = r2.get();	 Catch:{ all -> 0x0061 }
            r2 = (android.view.View) r2;	 Catch:{ all -> 0x0061 }
            if (r2 != 0) goto L_0x003e;	 Catch:{ all -> 0x0061 }
        L_0x0038:
            r2 = sViewsWithListeners;	 Catch:{ all -> 0x0061 }
            r2.remove(r1);	 Catch:{ all -> 0x0061 }
            goto L_0x005c;	 Catch:{ all -> 0x0061 }
        L_0x003e:
            r3 = r6.mViewsContainingListeners;	 Catch:{ all -> 0x0061 }
            r4 = java.lang.Boolean.TRUE;	 Catch:{ all -> 0x0061 }
            r3.put(r2, r4);	 Catch:{ all -> 0x0061 }
            r2 = r2.getParent();	 Catch:{ all -> 0x0061 }
        L_0x0049:
            r3 = r2 instanceof android.view.View;	 Catch:{ all -> 0x0061 }
            if (r3 == 0) goto L_0x005c;	 Catch:{ all -> 0x0061 }
        L_0x004d:
            r3 = r6.mViewsContainingListeners;	 Catch:{ all -> 0x0061 }
            r4 = r2;	 Catch:{ all -> 0x0061 }
            r4 = (android.view.View) r4;	 Catch:{ all -> 0x0061 }
            r5 = java.lang.Boolean.TRUE;	 Catch:{ all -> 0x0061 }
            r3.put(r4, r5);	 Catch:{ all -> 0x0061 }
            r2 = r2.getParent();	 Catch:{ all -> 0x0061 }
            goto L_0x0049;	 Catch:{ all -> 0x0061 }
        L_0x005c:
            r1 = r1 + -1;	 Catch:{ all -> 0x0061 }
            goto L_0x0026;	 Catch:{ all -> 0x0061 }
        L_0x005f:
        ...
        L_0x0061:
            ...
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.ViewCompat.UnhandledKeyEventManager.recalcViewsWithUnhandled():void");
        }

        static void registerListeningView(android.view.View r3) {
            /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:16:0x002c in {9, 12, 15} preds:[]
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.computeDominators(BlockProcessor.java:129)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.processBlocksTree(BlockProcessor.java:48)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.visit(BlockProcessor.java:38)
	at jadx.core.dex.visitors.DepthTraversal.visit(DepthTraversal.java:31)
...
*/
            ...
            r0 = sViewsWithListeners;
            monitor-enter(r0);
            r1 = sViewsWithListeners;	 Catch:{ all -> 0x0029 }
            r1 = r1.iterator();	 Catch:{ all -> 0x0029 }
        L_0x0009:
            r2 = r1.hasNext();	 Catch:{ all -> 0x0029 }
            if (r2 == 0) goto L_0x001d;	 Catch:{ all -> 0x0029 }
        L_0x000f:
            r2 = r1.next();	 Catch:{ all -> 0x0029 }
            r2 = (java.lang.ref.WeakReference) r2;	 Catch:{ all -> 0x0029 }
            r2 = r2.get();	 Catch:{ all -> 0x0029 }
            if (r2 != r3) goto L_0x0009;	 Catch:{ all -> 0x0029 }
        L_0x001b:
            monitor-exit(r0);	 Catch:{ all -> 0x0029 }
            return;	 Catch:{ all -> 0x0029 }
        L_0x001d:
            r1 = sViewsWithListeners;	 Catch:{ all -> 0x0029 }
            r2 = new java.lang.ref.WeakReference;	 Catch:{ all -> 0x0029 }
            r2.<init>(r3);	 Catch:{ all -> 0x0029 }
            r1.add(r2);	 Catch:{ all -> 0x0029 }
            monitor-exit(r0);	 Catch:{ all -> 0x0029 }
            return;	 Catch:{ all -> 0x0029 }
        L_0x0029:
            r3 = move-exception;	 Catch:{ all -> 0x0029 }
            monitor-exit(r0);	 Catch:{ all -> 0x0029 }
            throw r3;
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.ViewCompat.UnhandledKeyEventManager.registerListeningView(android.view.View):void");
        }

        static void unregisterListeningView(android.view.View r3) {
            /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:17:0x0029 in {10, 11, 13, 16} preds:[]
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.computeDominators(BlockProcessor.java:129)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.processBlocksTree(BlockProcessor.java:48)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.visit(BlockProcessor.java:38)
	at jadx.core.dex.visitors.DepthTraversal.visit(DepthTraversal.java:31)
...
*/
            ...
            r1 = 0;
        L_0x0004:
            r2 = sViewsWithListeners;	 Catch:{ all -> 0x0026 }
            r2 = r2.size();	 Catch:{ all -> 0x0026 }
            if (r1 >= r2) goto L_0x0024;	 Catch:{ all -> 0x0026 }
        L_0x000c:
            r2 = sViewsWithListeners;	 Catch:{ all -> 0x0026 }
            r2 = r2.get(r1);	 Catch:{ all -> 0x0026 }
            r2 = (java.lang.ref.WeakReference) r2;	 Catch:{ all -> 0x0026 }
            r2 = r2.get();	 Catch:{ all -> 0x0026 }
            if (r2 != r3) goto L_0x0021;	 Catch:{ all -> 0x0026 }
        L_0x001a:
            r3 = sViewsWithListeners;	 Catch:{ all -> 0x0026 }
            r3.remove(r1);	 Catch:{ all -> 0x0026 }
            monitor-exit(r0);	 Catch:{ all -> 0x0026 }
            return;	 Catch:{ all -> 0x0026 }
        L_0x0021:
            r1 = r1 + 1;	 Catch:{ all -> 0x0026 }
            goto L_0x0004;	 Catch:{ all -> 0x0026 }
        L_0x0024:
            monitor-exit(r0);	 Catch:{ all -> 0x0026 }
            return;	 Catch:{ all -> 0x0026 }
        L_0x0026:
            r3 = move-exception;	 Catch:{ all -> 0x0026 }
            monitor-exit(r0);	 Catch:{ all -> 0x0026 }
            throw r3;
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.ViewCompat.UnhandledKeyEventManager.unregisterListeningView(android.view.View):void");
        }
