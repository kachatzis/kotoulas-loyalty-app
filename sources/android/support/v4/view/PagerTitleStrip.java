...
public class PagerTitleStrip extends ViewGroup {
    ...
    private class PageListener extends DataSetObserver implements OnPageChangeListener, OnAdapterChangeListener {
        ...
        public void onPageSelected(int i) {
            if (this.mScrollState == 0) {
                i = PagerTitleStrip.this;
                i.updateText(i.mPager.getCurrentItem(), PagerTitleStrip.this.mPager.getAdapter());
                float f = 0.0f;
                if (PagerTitleStrip.this.mLastKnownPositionOffset >= 0) {
                    f = PagerTitleStrip.this.mLastKnownPositionOffset;
                }
                i = PagerTitleStrip.this;
                i.updateTextPositions(i.mPager.getCurrentItem(), f, true);
            }
        }
    ...
    void updateAdapter(PagerAdapter pagerAdapter, PagerAdapter pagerAdapter2) {
        ...
        pagerAdapter = this.mPager;
        if (pagerAdapter != null) {
            this.mLastKnownCurrentPage = -1;
            this.mLastKnownPositionOffset = -1.0f;
            updateText(pagerAdapter.getCurrentItem(), pagerAdapter2);
            requestLayout();
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        if (this.mPager) {
            z = this.mLastKnownPositionOffset;
            if (z >= false) {
                z = false;
            }
            updateTextPositions(this.mLastKnownCurrentPage, z, 1);
        }
    }
