...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C02331();
    ...
    private static final Interpolator sInterpolator = new C02342();
    ...
    private final Runnable mEndScrollRunnable = new C02353();
    ...
    static class C02331 implements Comparator<ItemInfo> {
        C02331() {
        }
    ...
    class C05064 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:145:0x0277 in {2, 3, 7, 11, 14, 24, 25, 26, 29, 34, 35, 38, 39, 46, 53, 54, 55, 61, 62, 63, 66, 67, 68, 69, 74, 75, 77, 78, 86, 93, 94, 100, 101, 104, 105, 106, 107, 116, 117, 122, 123, 126, 136, 137, 138, 141, 142, 144} preds:[]
...
*/
    ...
    L_0x021e:
        return;
    L_0x021f:
        r1 = r17.getResources();	 Catch:{ NotFoundException -> 0x022c }
        r2 = r17.getId();	 Catch:{ NotFoundException -> 0x022c }
        r1 = r1.getResourceName(r2);	 Catch:{ NotFoundException -> 0x022c }
        goto L_0x0234;
    L_0x022c:
        r1 = r17.getId();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C05064());
    }
    ...
    private boolean pageScrolled(int i) {
        if (this.mItems.size() != 0) {
            ...
            int i5 = (int) (((float) i3) * i);
            this.mCalledSuper = false;
            onPageScrolled(i4, i, i5);
        ...
        if (this.mDecorChildCount > 0) {
            ...
            for (paddingLeft = 0; paddingLeft < childCount; paddingLeft++) {
                ...
                if (layoutParams.isDecor) {
                    ...
                    if (i4 == 1) {
                        i4 = paddingRight;
                        paddingRight = Math.max((width - childAt.getMeasuredWidth()) / 2, paddingRight);
                    } else if (i4 == 3) {
    ...
    private int determineTargetPage(int i, float f, int i2, int i3) {
        ...
        ItemInfo itemInfo = (ItemInfo) this.mItems.get(0);
        i2 = this.mItems;
        return Math.max(itemInfo.position, Math.min(i, ((ItemInfo) i2.get(i2.size() - 1)).position));
    }
    ...
    public boolean arrowScroll(int i) {
        ...
        if (findFocus == null || findFocus == view) {
            ...
            z = (view == null || getChildRectInPagerCoordinates(this.mTempRect, findFocus).left > getChildRectInPagerCoordinates(this.mTempRect, view).left) ? findFocus.requestFocus() : pageRight();
        }
        if (z) {
