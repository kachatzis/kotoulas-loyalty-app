...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01551();
...
*/
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C04862();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C01551 implements ThreadFactory {
    ...
    class C04862 extends WorkerRunnable<Params, Result> {
        C04862() {
        }
