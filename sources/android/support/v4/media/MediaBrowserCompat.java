...
*/
            /*
            r10 = this;
            r0 = r10.mCallbacksMessengerRef;
            if (r0 == 0) goto L_0x00af;
        L_0x0004:
            r0 = r0.get();
            if (r0 == 0) goto L_0x00af;
        L_0x000a:
            r0 = r10.mCallbackImplRef;
            r0 = r0.get();
        ...
        L_0x0014:
            ...
            r1 = r10.mCallbackImplRef;
            r1 = r1.get();
            r1 = (android.support.v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl) r1;
            r2 = r10.mCallbacksMessengerRef;
            r2 = r2.get();
            r8 = r2;
            r8 = (android.os.Messenger) r8;
            r9 = 1;
            r2 = r11.what;	 Catch:{ BadParcelableException -> 0x009f }
            switch(r2) {
                case 1: goto L_0x005d;
                case 2: goto L_0x0059;
                case 3: goto L_0x0035;
                default: goto L_0x0032;
            };	 Catch:{ BadParcelableException -> 0x009f }
        L_0x0032:
            r0 = "MediaBrowserCompat";	 Catch:{ BadParcelableException -> 0x009f }
            goto L_0x0078;	 Catch:{ BadParcelableException -> 0x009f }
        L_0x0035:
            r2 = "data_options";	 Catch:{ BadParcelableException -> 0x009f }
            r6 = r0.getBundle(r2);	 Catch:{ BadParcelableException -> 0x009f }
            android.support.v4.media.session.MediaSessionCompat.ensureClassLoader(r6);	 Catch:{ BadParcelableException -> 0x009f }
            r2 = "data_notify_children_changed_options";	 Catch:{ BadParcelableException -> 0x009f }
            r7 = r0.getBundle(r2);	 Catch:{ BadParcelableException -> 0x009f }
            android.support.v4.media.session.MediaSessionCompat.ensureClassLoader(r7);	 Catch:{ BadParcelableException -> 0x009f }
            r2 = "data_media_item_id";	 Catch:{ BadParcelableException -> 0x009f }
            r4 = r0.getString(r2);	 Catch:{ BadParcelableException -> 0x009f }
            r2 = "data_media_item_list";	 Catch:{ BadParcelableException -> 0x009f }
            r5 = r0.getParcelableArrayList(r2);	 Catch:{ BadParcelableException -> 0x009f }
            r2 = r1;	 Catch:{ BadParcelableException -> 0x009f }
            r3 = r8;	 Catch:{ BadParcelableException -> 0x009f }
            r2.onLoadChildren(r3, r4, r5, r6, r7);	 Catch:{ BadParcelableException -> 0x009f }
            goto L_0x00ae;	 Catch:{ BadParcelableException -> 0x009f }
        L_0x0059:
            r1.onConnectionFailed(r8);	 Catch:{ BadParcelableException -> 0x009f }
            goto L_0x00ae;	 Catch:{ BadParcelableException -> 0x009f }
        L_0x005d:
            r2 = "data_root_hints";	 Catch:{ BadParcelableException -> 0x009f }
            r2 = r0.getBundle(r2);	 Catch:{ BadParcelableException -> 0x009f }
            android.support.v4.media.session.MediaSessionCompat.ensureClassLoader(r2);	 Catch:{ BadParcelableException -> 0x009f }
            r3 = "data_media_item_id";	 Catch:{ BadParcelableException -> 0x009f }
            r3 = r0.getString(r3);	 Catch:{ BadParcelableException -> 0x009f }
            r4 = "data_media_session_token";	 Catch:{ BadParcelableException -> 0x009f }
            r0 = r0.getParcelable(r4);	 Catch:{ BadParcelableException -> 0x009f }
            r0 = (android.support.v4.media.session.MediaSessionCompat.Token) r0;	 Catch:{ BadParcelableException -> 0x009f }
            r1.onServiceConnected(r8, r3, r0, r2);	 Catch:{ BadParcelableException -> 0x009f }
            goto L_0x00ae;	 Catch:{ BadParcelableException -> 0x009f }
        L_0x0078:
            r2 = new java.lang.StringBuilder;	 Catch:{ BadParcelableException -> 0x009f }
            r2.<init>();	 Catch:{ BadParcelableException -> 0x009f }
            r3 = "Unhandled message: ";	 Catch:{ BadParcelableException -> 0x009f }
            r2.append(r3);	 Catch:{ BadParcelableException -> 0x009f }
            r2.append(r11);	 Catch:{ BadParcelableException -> 0x009f }
            r3 = "\n  Client version: ";	 Catch:{ BadParcelableException -> 0x009f }
            r2.append(r3);	 Catch:{ BadParcelableException -> 0x009f }
            r2.append(r9);	 Catch:{ BadParcelableException -> 0x009f }
            r3 = "\n  Service version: ";	 Catch:{ BadParcelableException -> 0x009f }
            r2.append(r3);	 Catch:{ BadParcelableException -> 0x009f }
            r3 = r11.arg1;	 Catch:{ BadParcelableException -> 0x009f }
            r2.append(r3);	 Catch:{ BadParcelableException -> 0x009f }
            r2 = r2.toString();	 Catch:{ BadParcelableException -> 0x009f }
            android.util.Log.w(r0, r2);	 Catch:{ BadParcelableException -> 0x009f }
            goto L_0x00ae;
    ...
    public static class MediaItem implements Parcelable {
        public static final Creator<MediaItem> CREATOR = new C01771();
        ...
        static class C01771 implements Creator<MediaItem> {
            C01771() {
            }
...
*/
        ...
        L_0x0045:
            r2 = 0;
            r3 = r7.mCallbacksMessenger;	 Catch:{ RemoteException -> 0x0074 }
            r1.removeSubscription(r8, r2, r3);	 Catch:{ RemoteException -> 0x0074 }
            goto L_0x008a;	 Catch:{ RemoteException -> 0x0074 }
        L_0x004c:
            r1 = r0.getCallbacks();	 Catch:{ RemoteException -> 0x0074 }
            r2 = r0.getOptionsList();	 Catch:{ RemoteException -> 0x0074 }
            r3 = r1.size();	 Catch:{ RemoteException -> 0x0074 }
            r3 = r3 + -1;	 Catch:{ RemoteException -> 0x0074 }
        L_0x005a:
            if (r3 < 0) goto L_0x008a;	 Catch:{ RemoteException -> 0x0074 }
        L_0x005c:
            r4 = r1.get(r3);	 Catch:{ RemoteException -> 0x0074 }
            if (r4 != r9) goto L_0x0071;	 Catch:{ RemoteException -> 0x0074 }
        L_0x0062:
            r4 = r7.mServiceBinderWrapper;	 Catch:{ RemoteException -> 0x0074 }
            r5 = r9.mToken;	 Catch:{ RemoteException -> 0x0074 }
            r6 = r7.mCallbacksMessenger;	 Catch:{ RemoteException -> 0x0074 }
            r4.removeSubscription(r8, r5, r6);	 Catch:{ RemoteException -> 0x0074 }
            r1.remove(r3);	 Catch:{ RemoteException -> 0x0074 }
            r2.remove(r3);	 Catch:{ RemoteException -> 0x0074 }
        L_0x0071:
            r3 = r3 + -1;
            goto L_0x005a;
        L_0x0074:
...
*/
        ...
        public void onLoadChildren(Messenger messenger, String str, List list, Bundle bundle, Bundle bundle2) {
            if (this.mCallbacksMessenger == messenger) {
                ...
                messenger = subscription.getCallback(bundle);
                if (messenger != null) {
                    if (bundle == null) {
                        if (list == null) {
...
*/
            ...
            L_0x003e:
                ...
                r1 = 0;
                r2 = android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.this;	 Catch:{ Exception -> 0x0064 }
                r2 = r2.mContext;	 Catch:{ Exception -> 0x0064 }
                r3 = android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.this;	 Catch:{ Exception -> 0x0064 }
                r3 = r3.mServiceConnection;	 Catch:{ Exception -> 0x0064 }
                r4 = 1;	 Catch:{ Exception -> 0x0064 }
                r1 = r2.bindService(r0, r3, r4);	 Catch:{ Exception -> 0x0064 }
                goto L_0x007e;
            L_0x0064:
                r0 = "MediaBrowserCompat";
                r2 = new java.lang.StringBuilder;
...
*/
        ...
        public void connect() {
            ...
            this.mState = 2;
            this.mHandler.post(new C01691());
        }

        public void disconnect() {
            this.mState = 0;
            this.mHandler.post(new C01702());
        }
...
*/
        ...
        L_0x0056:
            ...
            if (r7 == 0) goto L_0x009c;	 Catch:{ RemoteException -> 0x0095 }
        L_0x005c:
        ...
        L_0x0077:
            ...
            if (r0 >= r1) goto L_0x0056;	 Catch:{ RemoteException -> 0x0095 }
        L_0x007d:
