...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static AudioAttributesCompat wrap(@NonNull Object obj) {
        ...
        obj = new AudioAttributesCompat();
        obj.mImpl = audioAttributesImplApi21;
        return obj;
    }
    ...
    public static AudioAttributesCompat fromBundle(Bundle bundle) {
        if (VERSION.SDK_INT >= 21) {
            bundle = AudioAttributesImplApi21.fromBundle(bundle);
        } else {
            bundle = AudioAttributesImplBase.fromBundle(bundle);
        }
        if (bundle == null) {
            return null;
        }
        return new AudioAttributesCompat(bundle);
    }
