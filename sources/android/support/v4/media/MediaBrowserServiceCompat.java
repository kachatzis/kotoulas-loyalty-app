...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ConnectionRecord implements DeathRecipient {
        ...
        public void binderDied() {
            MediaBrowserServiceCompat.this.mHandler.post(new C01781());
        }
    }
...
*/
                    ...
                    L_0x0044:
                        ...
                        r0 = r3;	 Catch:{ RemoteException -> 0x0072 }
                        r0.onConnectFailed();	 Catch:{ RemoteException -> 0x0072 }
                        goto L_0x00d9;
                    L_0x0072:
                        r0 = "MBServiceCompat";
                        r1 = new java.lang.StringBuilder;
                        ...
                        goto L_0x00d9;
                    L_0x008b:
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.this;	 Catch:{ RemoteException -> 0x00b8 }
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.this;	 Catch:{ RemoteException -> 0x00b8 }
                        r2 = r2.mConnections;	 Catch:{ RemoteException -> 0x00b8 }
                        r2.put(r0, r1);	 Catch:{ RemoteException -> 0x00b8 }
                        r2 = 0;	 Catch:{ RemoteException -> 0x00b8 }
                        r0.linkToDeath(r1, r2);	 Catch:{ RemoteException -> 0x00b8 }
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.this;	 Catch:{ RemoteException -> 0x00b8 }
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.this;	 Catch:{ RemoteException -> 0x00b8 }
                        r2 = r2.mSession;	 Catch:{ RemoteException -> 0x00b8 }
                        if (r2 == 0) goto L_0x00d9;	 Catch:{ RemoteException -> 0x00b8 }
                    L_0x00a0:
                        r2 = r3;	 Catch:{ RemoteException -> 0x00b8 }
                        r3 = r1.root;	 Catch:{ RemoteException -> 0x00b8 }
                        r3 = r3.getRootId();	 Catch:{ RemoteException -> 0x00b8 }
                        r4 = android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.this;	 Catch:{ RemoteException -> 0x00b8 }
                        r4 = android.support.v4.media.MediaBrowserServiceCompat.this;	 Catch:{ RemoteException -> 0x00b8 }
                        r4 = r4.mSession;	 Catch:{ RemoteException -> 0x00b8 }
                        r1 = r1.root;	 Catch:{ RemoteException -> 0x00b8 }
                        r1 = r1.getExtras();	 Catch:{ RemoteException -> 0x00b8 }
                        r2.onConnect(r3, r4, r1);	 Catch:{ RemoteException -> 0x00b8 }
                        goto L_0x00d9;
                    L_0x00b8:
                        r1 = "MBServiceCompat";
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 3:
                    ...
                    this.mServiceBinderImpl.addSubscription(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), BundleCompat.getBinder(data, MediaBrowserProtocol.DATA_CALLBACK_TOKEN), bundle, new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 4:
...
*/
    ...
    private static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        public void onLoadChildren(String str, List<MediaItem> list, Bundle bundle, Bundle bundle2) throws RemoteException {
            ...
            if (list != null) {
                bundle3.putParcelableArrayList(MediaBrowserProtocol.DATA_MEDIA_ITEM_LIST, (list instanceof ArrayList) != null ? (ArrayList) list : new ArrayList(list));
            }
    ...
    boolean removeSubscription(java.lang.String r7, android.support.v4.media.MediaBrowserServiceCompat.ConnectionRecord r8, android.os.IBinder r9) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:26:0x0056 in {5, 6, 8, 17, 20, 22, 25} preds:[]
...
*/
    ...
    L_0x0005:
        r9 = r8.subscriptions;	 Catch:{ all -> 0x004d }
        r9 = r9.remove(r7);	 Catch:{ all -> 0x004d }
    ...
    L_0x000e:
        r0 = 0;
    L_0x000f:
        r6.mCurConnection = r8;
        r6.onUnsubscribe(r7);
        r6.mCurConnection = r2;
        return r0;
    L_0x0017:
        r3 = r8.subscriptions;	 Catch:{ all -> 0x004d }
        r3 = r3.get(r7);	 Catch:{ all -> 0x004d }
        r3 = (java.util.List) r3;	 Catch:{ all -> 0x004d }
        if (r3 == 0) goto L_0x0045;	 Catch:{ all -> 0x004d }
    L_0x0021:
        r4 = r3.iterator();	 Catch:{ all -> 0x004d }
    L_0x0025:
        r5 = r4.hasNext();	 Catch:{ all -> 0x004d }
        if (r5 == 0) goto L_0x003a;	 Catch:{ all -> 0x004d }
    L_0x002b:
        r5 = r4.next();	 Catch:{ all -> 0x004d }
        r5 = (android.support.v4.util.Pair) r5;	 Catch:{ all -> 0x004d }
        r5 = r5.first;	 Catch:{ all -> 0x004d }
        if (r9 != r5) goto L_0x0025;	 Catch:{ all -> 0x004d }
    L_0x0035:
        r4.remove();	 Catch:{ all -> 0x004d }
        r1 = 1;	 Catch:{ all -> 0x004d }
        goto L_0x0025;	 Catch:{ all -> 0x004d }
    L_0x003a:
        r9 = r3.size();	 Catch:{ all -> 0x004d }
        if (r9 != 0) goto L_0x0045;	 Catch:{ all -> 0x004d }
    L_0x0040:
        r9 = r8.subscriptions;	 Catch:{ all -> 0x004d }
        r9.remove(r7);	 Catch:{ all -> 0x004d }
    L_0x0045:
        r6.mCurConnection = r8;
        r6.onUnsubscribe(r7);
        r6.mCurConnection = r2;
    ...
    void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle, Bundle bundle2) {
        ...
        Result c04891 = new Result<List<MediaItem>>(str) {
            void onResultSent(java.util.List<android.support.v4.media.MediaBrowserCompat.MediaItem> r5) {
                /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
            ...
            L_0x0014:
                r5 = android.support.v4.media.MediaBrowserServiceCompat.DEBUG;
            ...
            L_0x0045:
                r0 = android.support.v4.media.MediaBrowserServiceCompat.this;
                r1 = r5;
                r5 = r0.applyOptions(r5, r1);
            L_0x004d:
                r0 = r3;	 Catch:{ RemoteException -> 0x005b }
                r0 = r0.callbacks;	 Catch:{ RemoteException -> 0x005b }
                r1 = r4;	 Catch:{ RemoteException -> 0x005b }
                r2 = r5;	 Catch:{ RemoteException -> 0x005b }
                r3 = r6;	 Catch:{ RemoteException -> 0x005b }
                r0.onLoadChildren(r1, r5, r2, r3);	 Catch:{ RemoteException -> 0x005b }
                goto L_0x007f;
            L_0x005b:
                r5 = "MBServiceCompat";
                r0 = new java.lang.StringBuilder;
        ...
        this.mCurConnection = connectionRecord;
        if (bundle == null) {
            onLoadChildren(str, c04891);
        } else {
            onLoadChildren(str, c04891, bundle);
        }
        this.mCurConnection = null;
        if (c04891.isDone() == null) {
            bundle2 = new StringBuilder();
            bundle2.append("onLoadChildren must call detach() or sendResult() before returning for package=");
            bundle2.append(connectionRecord.pkg);
            bundle2.append(" id=");
            bundle2.append(str);
            throw new IllegalStateException(bundle2.toString());
        }
    }
    ...
    void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result c04902 = new Result<MediaItem>(str) {
            void onResultSent(MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
        ...
        this.mCurConnection = connectionRecord;
        onLoadItem(str, c04902);
        this.mCurConnection = null;
        if (c04902.isDone() == null) {
    ...
    void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result c04913 = new Result<List<MediaItem>>(str) {
            void onResultSent(List<MediaItem> list) {
                if ((getFlags() & 4) == 0) {
                    if (list != null) {
                        Bundle bundle = new Bundle();
        ...
        this.mCurConnection = connectionRecord;
        onSearch(str, bundle, c04913);
        this.mCurConnection = null;
        if (c04913.isDone() == null) {
    ...
    void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result c04924 = new Result<Bundle>(str) {
        ...
        this.mCurConnection = connectionRecord;
        onCustomAction(str, bundle, c04924);
        this.mCurConnection = null;
        if (c04924.isDone() == null) {
            resultReceiver = new StringBuilder();
