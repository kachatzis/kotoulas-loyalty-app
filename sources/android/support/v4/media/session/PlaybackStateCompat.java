...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C02041();
    ...
    static class C02041 implements Creator<PlaybackStateCompat> {
        C02041() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C02051();
        ...
        static class C02051 implements Creator<CustomAction> {
            C02051() {
            }
    ...
    public Object getPlaybackState() {
        if (this.mStateObj == null && VERSION.SDK_INT >= 21) {
            ...
            if (VERSION.SDK_INT >= 22) {
                r0.mStateObj = PlaybackStateCompatApi22.newInstance(r0.mState, r0.mPosition, r0.mBufferedPosition, r0.mSpeed, r0.mActions, r0.mErrorMessage, r0.mUpdateTime, list, r0.mActiveItemId, r0.mExtras);
            } else {
                r0.mStateObj = PlaybackStateCompatApi21.newInstance(r0.mState, r0.mPosition, r0.mBufferedPosition, r0.mSpeed, r0.mActions, r0.mErrorMessage, r0.mUpdateTime, list, r0.mActiveItemId);
            }
        }
        return r0.mStateObj;
    }
