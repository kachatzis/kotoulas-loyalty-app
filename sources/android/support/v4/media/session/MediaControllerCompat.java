    ...
    public static abstract class Callback implements DeathRecipient {
        ...
        void postToHandler(int i, Object obj, Bundle bundle) {
            ...
            if (messageHandler != null) {
                i = messageHandler.obtainMessage(i, obj);
                i.setData(bundle);
                i.sendToTarget();
            }
        }
        ...
        if (mediaSessionCompat != null) {
            ...
            try {
                if (VERSION.SDK_INT >= 24) {
                    mediaSessionCompat = new MediaControllerImplApi24(context, this.mToken);
                } else if (VERSION.SDK_INT >= 23) {
                    mediaSessionCompat = new MediaControllerImplApi23(context, this.mToken);
                } else if (VERSION.SDK_INT >= 21) {
                    mediaSessionCompat = new MediaControllerImplApi21(context, this.mToken);
                } else {
                    mediaSessionCompat = new MediaControllerImplBase(this.mToken);
                }
            } catch (Context context2) {
                Log.w(TAG, "Failed to create MediaControllerImpl.", context2);
            }
