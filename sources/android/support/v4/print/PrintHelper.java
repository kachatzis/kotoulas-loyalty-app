        ...
        public void onLayout(PrintAttributes printAttributes, PrintAttributes printAttributes2, CancellationSignal cancellationSignal, LayoutResultCallback layoutResultCallback, Bundle bundle) {
            ...
            if (cancellationSignal.isCanceled() != null) {
                ...
                this.mLoadBitmap = new AsyncTask<Uri, Boolean, Bitmap>() {
                    ...
                    class C02081 implements OnCancelListener {
                        C02081() {
                        }

                        public void onCancel() {
                            PrintUriAdapter.this.cancelLoad();
                            C02091.this.cancel(false);
                        }
                    }

                    protected void onPreExecute() {
                        cancellationSignal2.setOnCancelListener(new C02081());
                    }
...
*/
    ...
    android.graphics.Bitmap loadConstrainedBitmap(android.net.Uri r8) throws java.io.FileNotFoundException {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:50:0x006e in {6, 10, 14, 27, 30, 37, 41, 45, 46, 47, 49} preds:[]
...
*/
    ...
    L_0x0033:
        r0 = r7.mLock;
        monitor-enter(r0);
        r2 = new android.graphics.BitmapFactory$Options;	 Catch:{ all -> 0x0061 }
        r2.<init>();	 Catch:{ all -> 0x0061 }
        r7.mDecodeOptions = r2;	 Catch:{ all -> 0x0061 }
        r2 = r7.mDecodeOptions;	 Catch:{ all -> 0x0061 }
        r2.inMutable = r1;	 Catch:{ all -> 0x0061 }
        r1 = r7.mDecodeOptions;	 Catch:{ all -> 0x0061 }
        r1.inSampleSize = r5;	 Catch:{ all -> 0x0061 }
        r1 = r7.mDecodeOptions;	 Catch:{ all -> 0x0061 }
        monitor-exit(r0);	 Catch:{ all -> 0x0061 }
        r8 = r7.loadBitmap(r8, r1);	 Catch:{ all -> 0x0056 }
        r0 = r7.mLock;
        monitor-enter(r0);
        r7.mDecodeOptions = r3;	 Catch:{ all -> 0x0053 }
        monitor-exit(r0);	 Catch:{ all -> 0x0053 }
        return r8;	 Catch:{ all -> 0x0053 }
    L_0x0053:
        r8 = move-exception;	 Catch:{ all -> 0x0053 }
        monitor-exit(r0);	 Catch:{ all -> 0x0053 }
        throw r8;
    L_0x0056:
        r8 = move-exception;
        r1 = r7.mLock;
        monitor-enter(r1);
        r7.mDecodeOptions = r3;	 Catch:{ all -> 0x005e }
    ...
    L_0x0066:
        ...
        r0 = "bad argument to getScaledBitmap";
        r8.<init>(r0);
        throw r8;
        return;
        */
