...
*/
    ...
    public V put(K k, V v) {
        ...
        if (indexOfNull < i2) {
            ...
            i3 = indexOfNull + 1;
            System.arraycopy(obj4, indexOfNull, obj4, i3, i2 - indexOfNull);
            obj4 = this.mArray;
            System.arraycopy(obj4, indexOfNull << 1, obj4, i3 << 1, (this.mSize - indexOfNull) << 1);
        }
        int i4 = this.mSize;
        if (i2 == i4) {
            int[] iArr = this.mHashes;
        ...
        if (i4 <= 1) {
            ...
            if (iArr.length <= 8 || i4 >= iArr.length / 3) {
                if (i < i2) {
                    ...
                    i = this.mArray;
                    System.arraycopy(i, i6 << 1, i, i3, i7 << 1);
                }
                i = this.mArray;
                i3 = i2 << 1;
                i[i3] = null;
                ...
                if (i4 == this.mSize) {
                    if (i > 0) {
                        ...
                        System.arraycopy(obj3, 0, this.mArray, 0, i3);
                    }
                    if (i < i2) {
                        int i8 = i + 1;
                        int i9 = i2 - i;
                        System.arraycopy(obj2, i8, this.mHashes, i, i9);
                        System.arraycopy(obj3, i8 << 1, this.mArray, i3, i9 << 1);
                    }
                } else {
                    throw new ConcurrentModificationException();
                }
