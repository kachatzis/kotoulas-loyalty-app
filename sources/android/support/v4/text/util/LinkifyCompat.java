...
public final class LinkifyCompat {
    private static final Comparator<LinkSpec> COMPARATOR = new C02261();
    private static final String[] EMPTY_STRING = new String[0];

    /* renamed from: android.support.v4.text.util.LinkifyCompat$1 */
    static class C02261 implements Comparator<LinkSpec> {
        C02261() {
        }
    ...
    private static void pruneOverlaps(ArrayList<LinkSpec> arrayList, Spannable spannable) {
        ...
        while (i2 < size - 1) {
            ...
            if (linkSpec2.start <= linkSpec3.start && linkSpec2.end > linkSpec3.start) {
                i = linkSpec3.end <= linkSpec2.end ? i3 : linkSpec2.end - linkSpec2.start > linkSpec3.end - linkSpec3.start ? i3 : linkSpec2.end - linkSpec2.start < linkSpec3.end - linkSpec3.start ? i2 : -1;
                if (i != -1) {
