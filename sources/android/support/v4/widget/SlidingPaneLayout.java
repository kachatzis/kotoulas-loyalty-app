...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private class DragHelperCallback extends Callback {
        ...
        public void onViewDragStateChanged(int i) {
            ...
            if (SlidingPaneLayout.this.mSlideOffset == 0) {
                i = SlidingPaneLayout.this;
                i.updateObscuredViewsVisibility(i.mSlideableView);
                i = SlidingPaneLayout.this;
                i.dispatchOnPanelClosed(i.mSlideableView);
                SlidingPaneLayout.this.mPreservedOpenState = false;
                return;
            }
            i = SlidingPaneLayout.this;
            i.dispatchOnPanelOpened(i.mSlideableView);
                        ...
                        if (!z2 || childAt2 == slidingPaneLayout.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    i5 = MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), 1073741824);
                                } else if (layoutParams2.height == -2) {
                                    i5 = MeasureSpec.makeMeasureSpec(paddingTop, Integer.MIN_VALUE);
                                } else if (layoutParams2.height == -1) {
                                    i5 = MeasureSpec.makeMeasureSpec(paddingTop, 1073741824);
                                } else {
                                    i5 = MeasureSpec.makeMeasureSpec(layoutParams2.height, 1073741824);
                                }
                                if (z2) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (paddingRight = 0; paddingRight < childCount; paddingRight++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    i8 = i5 - paddingLeft;
                    min = (Math.min(i6, i8 - slidingPaneLayout.mOverhangSize) - i7) - (layoutParams.leftMargin + layoutParams.rightMargin);
                    ...
                    i8 = (int) (((float) min) * slidingPaneLayout.mSlideOffset);
                    i9 = (i9 + i8) + i7;
                    slidingPaneLayout.mSlideOffset = ((float) i8) / ((float) slidingPaneLayout.mSlideRange);
                    i8 = 0;
                } else {
                    if (slidingPaneLayout.mCanSlide) {
                        i9 = slidingPaneLayout.mParallaxBy;
                        if (i9 != 0) {
                            i8 = (int) ((1.0f - slidingPaneLayout.mSlideOffset) * ((float) i9));
                            i9 = i6;
                        }
                    }
                    i9 = i6;
        ...
        if (slidingPaneLayout.mFirstLayout) {
            if (slidingPaneLayout.mCanSlide) {
                ...
                for (int i10 = 0; i10 < childCount; i10++) {
                    dimChildView(getChildAt(i10), 0.0f, slidingPaneLayout.mSliderFadeColor);
                }
            }
            updateObscuredViewsVisibility(slidingPaneLayout.mSlideableView);
            isLayoutRtlSupport = false;
        } else {
            isLayoutRtlSupport = false;
        }
        slidingPaneLayout.mFirstLayout = isLayoutRtlSupport;
    }
    ...
    boolean smoothSlideTo(float f, int i) {
        ...
        if (i.smoothSlideViewTo(view, f, view.getTop()) == null) {
            return false;
        }
