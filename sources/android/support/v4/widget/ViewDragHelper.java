...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C02561();
    ...
    private final Runnable mSetIdleRunnable = new C02572();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    /* renamed from: android.support.v4.widget.ViewDragHelper$1 */
    static class C02561 implements Interpolator {
    ...
    private void ensureMotionHistorySizeForId(int i) {
        ...
        if (fArr == null || fArr.length <= i) {
            ...
            i = new int[i];
            Object obj7 = this.mInitialMotionX;
            if (obj7 != null) {
                System.arraycopy(obj7, 0, obj, 0, obj7.length);
                obj7 = this.mInitialMotionY;
                System.arraycopy(obj7, 0, obj2, 0, obj7.length);
                obj7 = this.mLastMotionX;
                System.arraycopy(obj7, 0, obj3, 0, obj7.length);
                obj7 = this.mLastMotionY;
                System.arraycopy(obj7, 0, obj4, 0, obj7.length);
                obj7 = this.mInitialEdgesTouched;
                System.arraycopy(obj7, 0, obj5, 0, obj7.length);
                obj7 = this.mEdgeDragsInProgress;
                System.arraycopy(obj7, 0, obj6, 0, obj7.length);
                obj7 = this.mEdgeDragsLocked;
                System.arraycopy(obj7, 0, i, 0, obj7.length);
            }
    ...
    public boolean shouldInterceptTouchEvent(@NonNull MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            case 0:
                ...
                actionIndex = viewDragHelper.mTrackingEdges;
                if ((actionMasked & actionIndex) != 0) {
                    viewDragHelper.mCallback.onEdgeTouched(actionMasked & actionIndex, pointerId);
                    break;
                }
                break;
            case 1:
            ...
            case 5:
                ...
                actionIndex = viewDragHelper.mDragState;
                if (actionIndex != 0) {
                    if (actionIndex == 2) {
                ...
                if ((pointerId & actionIndex) != 0) {
                    viewDragHelper.mCallback.onEdgeTouched(pointerId & actionIndex, actionMasked);
                }
                z = false;
                break;
            case 6:
    ...
    public void processTouchEvent(@NonNull MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            case 0:
                ...
                if ((actionMasked & actionIndex) != 0) {
                    this.mCallback.onEdgeTouched(actionMasked & actionIndex, motionEvent);
                    return;
                }
                return;
            case 1:
            ...
            case 5:
                ...
                if (this.mDragState == 0) {
                    ...
                    if ((motionEvent & actionIndex) != 0) {
                        this.mCallback.onEdgeTouched(motionEvent & actionIndex, actionMasked);
                        return;
                    }
                    return;
                ...
                if (this.mDragState == 1 && actionMasked == this.mActivePointerId) {
                    ...
                    while (i < actionIndex) {
                        ...
                        if (pointerId != this.mActivePointerId) {
                            ...
                            if (findTopChildUnder3 == view && tryCaptureViewForDrag(view, pointerId)) {
    ...
    private boolean checkTouchSlop(View view, float f, float f2) {
        ...
        if (obj != null && view != null) {
            f = (f * f) + (f2 * f2);
            view = this.mTouchSlop;
            if (f > ((float) (view * view))) {
                z = true;
            }
            return z;
        } else if (obj != null) {
