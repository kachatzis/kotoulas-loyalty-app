...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent2, NestedScrollingChild2, ScrollingView {
            ...
            case 2:
                ...
                if (findPointerIndex != -1) {
                    ...
                    if (dispatchNestedPreScroll(0, i2, nestedScrollView.mScrollConsumed, nestedScrollView.mScrollOffset, 0)) {
                        i2 -= nestedScrollView.mScrollConsumed[1];
                    ...
                    if (nestedScrollView.mIsBeingDragged || Math.abs(i2) <= nestedScrollView.mTouchSlop) {
                        ...
                        i = i2 > 0 ? i2 - nestedScrollView.mTouchSlop : i2 + nestedScrollView.mTouchSlop;
                    }
                    if (nestedScrollView.mIsBeingDragged) {
                        ...
                        if (actionMasked != 0) {
                            if (actionMasked != 1 || i2 <= 0) {
                                obj = null;
                                i3 = i2;
                                i4 = i;
                                i5 = findPointerIndex;
                                if (overScrollByCompat(0, i, 0, getScrollY(), 0, i2, 0, 0, true) && !hasNestedScrollingParent(0)) {
                                ...
                                nestedScrollView.mLastMotionY = actionMasked - iArr[1];
    ...
    public void computeScroll() {
        ...
        if (this.mScroller.computeScrollOffset()) {
            ...
            int i2 = dispatchNestedPreScroll(0, i, r10.mScrollConsumed, null, 1) ? i - r10.mScrollConsumed[1] : i;
            if (i2 != 0) {
                int scrollRange = getScrollRange();
                int scrollY = getScrollY();
                int i3 = scrollY;
        ...
        r10.mLastScrollerY = overScrollMode;
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        i = this.mChildToScrollTo;
        if (!(i == 0 || isViewDescendantOf(i, this) == 0)) {
