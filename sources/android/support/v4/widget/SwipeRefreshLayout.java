...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C02481 implements AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            if (SwipeRefreshLayout.this.mRefreshing != null) {
                ...
                animation = SwipeRefreshLayout.this;
    ...
    class C02492 extends Animation {
        C02492() {
        }
    ...
    class C02503 extends Animation {
        C02503() {
        }
    ...
    class C02525 implements AnimationListener {
        public void onAnimationRepeat(Animation animation) {
        }
    ...
    class C02536 extends Animation {
        C02536() {
        }
    ...
    class C02547 extends Animation {
        C02547() {
        }
    ...
    class C02558 extends Animation {
        C02558() {
        }
    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new C02481();
        this.mAnimateToCorrectPosition = new C02536();
        this.mAnimateToStartPosition = new C02547();
    ...
    private void startScaleUpAnimation(AnimationListener animationListener) {
        ...
        this.mScaleAnimation = new C02492();
    ...
    void startScaleDownAnimation(AnimationListener animationListener) {
        this.mScaleDownAnimation = new C02503();
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        Animation c02514 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                transformation = SwipeRefreshLayout.this.mProgress;
                int i = i;
                transformation.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f)));
            }
        };
        c02514.setDuration(ALPHA_ANIMATION_DURATION);
        this.mCircleView.setAnimationListener(0);
        this.mCircleView.clearAnimation();
        this.mCircleView.startAnimation(c02514);
        return c02514;
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        i = this.mTarget;
        if (i != 0) {
            i.measure(MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), 1073741824), MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), 1073741824));
    ...
    private void startDragging(float f) {
        ...
        if (f > ((float) i) && this.mIsBeingDragged == null) {
    ...
    private void startScaleDownReturnToStartAnimation(int i, AnimationListener animationListener) {
        ...
        this.mScaleDownToStartAnimation = new C02558();
