...
class TypefaceCompatBaseImpl {
    ...
    class C04871 implements StyleExtractor<FontInfo> {
        C04871() {
        }
    ...
    class C04882 implements StyleExtractor<FontFileResourceEntry> {
        C04882() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fontInfoArr, int i) {
        return (FontInfo) findBestFont(fontInfoArr, i, new C04871());
    }
...
*/
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i) {
        return (FontFileResourceEntry) findBestFont(fontFamilyFilesResourceEntry.getEntries(), i, new C04882());
    }
