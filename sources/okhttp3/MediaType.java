...
*/
        /*
        r1 = this;
        r0 = r1.charset;	 Catch:{ IllegalArgumentException -> 0x000b }
        if (r0 == 0) goto L_0x000a;	 Catch:{ IllegalArgumentException -> 0x000b }
    L_0x0004:
        r0 = r1.charset;	 Catch:{ IllegalArgumentException -> 0x000b }
        r2 = java.nio.charset.Charset.forName(r0);	 Catch:{ IllegalArgumentException -> 0x000b }
    L_0x000a:
        return r2;
    L_0x000b:
        return r2;
