...
public abstract class RequestBody {
    ...
    class C06211 extends RequestBody {
        final /* synthetic */ ByteString val$content;
        final /* synthetic */ MediaType val$contentType;

        C06211(MediaType mediaType, ByteString byteString) {
    ...
    class C06222 extends RequestBody {
        final /* synthetic */ int val$byteCount;
        final /* synthetic */ byte[] val$content;
        final /* synthetic */ MediaType val$contentType;
        final /* synthetic */ int val$offset;

        C06222(MediaType mediaType, int i, byte[] bArr, int i2) {
            this.val$contentType = mediaType;
    ...
    class C06233 extends RequestBody {
        final /* synthetic */ MediaType val$contentType;
        final /* synthetic */ File val$file;

        C06233(MediaType mediaType, File file) {
            this.val$contentType = mediaType;
            this.val$file = file;
        }
    ...
    public static RequestBody create(@Nullable MediaType mediaType, ByteString byteString) {
        return new C06211(mediaType, byteString);
    }
    ...
    public static RequestBody create(@Nullable MediaType mediaType, byte[] bArr, int i, int i2) {
        if (bArr != null) {
            ...
            return new C06222(mediaType, i2, bArr, i);
        }
    ...
    public static RequestBody create(@Nullable MediaType mediaType, File file) {
        if (file != null) {
            return new C06233(mediaType, file);
        }
        throw new NullPointerException("content == null");
    }
}
