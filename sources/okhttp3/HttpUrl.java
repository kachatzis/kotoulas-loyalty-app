...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:51:0x009b in {5, 11, 14, 15, 19, 24, 25, 26, 27, 32, 33, 38, 39, 40, 44, 45, 48, 50} preds:[]
...
*/
        ...
        L_0x0090:
            r10 = java.net.InetAddress.getByAddress(r0);	 Catch:{ UnknownHostException -> 0x0095 }
            return r10;
        L_0x0095:
            ...
            if (slashCount < 2 && httpUrl2 != null) {
                if (httpUrl2.scheme.equals(builder.scheme)) {
                    ...
                    if (delimiterOffset < skipTrailingAsciiWhitespace && str2.charAt(delimiterOffset) == '?') {
                        ...
                        builder.encodedQueryNamesAndValues = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(str, delimiterOffset + 1, skipLeadingAsciiWhitespace, HttpUrl.QUERY_ENCODE_SET, true, false, true, true));
                        delimiterOffset = skipLeadingAsciiWhitespace;
                    }
                    if (delimiterOffset < skipTrailingAsciiWhitespace && str2.charAt(delimiterOffset) == '#') {
                        builder.encodedFragment = HttpUrl.canonicalize(str, 1 + delimiterOffset, skipTrailingAsciiWhitespace, "", true, false, false, false);
                    }
                    ...
                    switch (charAt) {
                        ...
                        case '@':
                            if (obj == null) {
                                ...
                                i = delimiterOffset2;
                                String canonicalize = HttpUrl.canonicalize(str, slashCount, delimiterOffset3, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true);
                                if (obj2 != null) {
                                    StringBuilder stringBuilder = new StringBuilder();
                                ...
                                if (i2 != i) {
                                    builder.encodedPassword = HttpUrl.canonicalize(str, i2 + 1, i, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true);
                                    obj = 1;
                                }
                                obj2 = 1;
                            } else {
                                ...
                                stringBuilder2.append(HttpUrl.canonicalize(str, slashCount, i, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true));
        ...
        private void push(String str, int i, int i2, boolean z, boolean z2) {
            ...
            if (isDot(str) == 0) {
                ...
                i = this.encodedPathSegments;
                if (((String) i.get(i.size() - 1)).isEmpty() != 0) {
                    i = this.encodedPathSegments;
                    i.set(i.size() - 1, str);
                } else {
