...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C03801();
    ...
    static class C03801 implements Comparator<Comparable> {
        C03801() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C05731 extends LinkedTreeMapIterator<Entry<K, V>> {
            C05731() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C05741 extends LinkedTreeMapIterator<K> {
            C05741() {
                super();
            }
