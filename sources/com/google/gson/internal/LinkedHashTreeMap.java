...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C03791();
    ...
    static class C03791 implements Comparator<Comparable> {
        C03791() {
        }
    ...
    static final class AvlBuilder<K, V> {
        ...
        void add(Node<K, V> node) {
            ...
            this.stack = node;
            this.size += 1;
            node = this.leavesToSkip;
            if (node > null) {
                i2 = this.size;
                if ((i2 & 1) == 0) {
                    this.size = i2 + 1;
                    this.leavesToSkip = node - 1;
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C05711 extends LinkedTreeMapIterator<Entry<K, V>> {
            C05711() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C05721 extends LinkedTreeMapIterator<K> {
            C05721() {
                super();
            }
    ...
    public LinkedHashTreeMap(Comparator<? super K> comparator) {
        ...
        comparator = this.table;
        this.threshold = (comparator.length / 2) + (comparator.length / 4);
    }
...
*/
    ...
    L_0x0003:
        r1 = 0;
        r0 = r2.find(r3, r1);	 Catch:{ ClassCastException -> 0x0009 }
        goto L_0x000a;
    L_0x0009:
        return r0;
    L_0x000a:
    ...
    private void replaceInParent(Node<K, V> node, Node<K, V> node2) {
        ...
        if (node3 == null) {
            node = node.hash;
            Node[] nodeArr = this.table;
            nodeArr[node & (nodeArr.length - 1)] = node2;
