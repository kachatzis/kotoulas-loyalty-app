...
public final class TypeAdapters {
    public static final TypeAdapter<AtomicBoolean> ATOMIC_BOOLEAN = new C05959().nullSafe();
    public static final TypeAdapterFactory ATOMIC_BOOLEAN_FACTORY = newFactory(AtomicBoolean.class, ATOMIC_BOOLEAN);
    public static final TypeAdapter<AtomicInteger> ATOMIC_INTEGER = new C05948().nullSafe();
    ...
    public static final TypeAdapter<BitSet> BIT_SET = new C05872().nullSafe();
    public static final TypeAdapterFactory BIT_SET_FACTORY = newFactory(BitSet.class, BIT_SET);
    public static final TypeAdapter<Boolean> BOOLEAN = new C05893();
    public static final TypeAdapter<Boolean> BOOLEAN_AS_STRING = new C05904();
    public static final TypeAdapterFactory BOOLEAN_FACTORY = newFactory(Boolean.TYPE, Boolean.class, BOOLEAN);
    public static final TypeAdapter<Number> BYTE = new C05915();
    ...
    public static final TypeAdapter<Class> CLASS = new C05851().nullSafe();
    ...
    public static final TypeAdapter<Number> INTEGER = new C05937();
    ...
    public static final TypeAdapter<Number> SHORT = new C05926();
    ...
    static class C05851 extends TypeAdapter<Class> {
        C05851() {
        }
    ...
    static class C05872 extends TypeAdapter<BitSet> {
        C05872() {
        }
...
*/
        ...
        L_0x0035:
            r1 = r7.nextString();
            r1 = java.lang.Integer.parseInt(r1);	 Catch:{ NumberFormatException -> 0x0042 }
    ...
    static class C05893 extends TypeAdapter<Boolean> {
        C05893() {
        }
    ...
    static class C05904 extends TypeAdapter<Boolean> {
        C05904() {
        }
    ...
    static class C05915 extends TypeAdapter<Number> {
        C05915() {
        }
    ...
    static class C05926 extends TypeAdapter<Number> {
        C05926() {
        }
    ...
    static class C05937 extends TypeAdapter<Number> {
        C05937() {
        }
    ...
    static class C05948 extends TypeAdapter<AtomicInteger> {
        C05948() {
        }
    ...
    static class C05959 extends TypeAdapter<AtomicBoolean> {
        C05959() {
        }
    ...
    private static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public EnumTypeAdapter(java.lang.Class<T> r12) {
            /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:15:0x005b in {8, 10, 11, 14} preds:[]
