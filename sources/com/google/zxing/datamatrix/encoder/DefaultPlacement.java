...
public class DefaultPlacement {
    ...
    public final void place() {
        ...
        while (true) {
            int i4;
            int i5;
            if (i == this.numrows && r2 == 0) {
                i4 = i3 + 1;
                corner1(i3);
                i3 = i4;
            }
            if (i == this.numrows - 2 && r2 == 0 && this.numcols % 4 != 0) {
                i4 = i3 + 1;
                corner2(i3);
                i3 = i4;
            }
            if (i == this.numrows - 2 && r2 == 0 && this.numcols % 8 == 4) {
                i4 = i3 + 1;
                corner3(i3);
                i3 = i4;
            }
            if (i == this.numrows + 4 && r2 == 2 && this.numcols % 8 == 0) {
                i4 = i3 + 1;
                corner4(i3);
                i3 = i4;
            }
            ...
            i2 += 3;
            do {
                if (i >= 0 && i2 < this.numcols && !hasBit(i2, i)) {
                    i4 = i3 + 1;
                    utah(i, i2, i3);
                    i3 = i4;
                }
