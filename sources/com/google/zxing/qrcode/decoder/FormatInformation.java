...
final class FormatInformation {
    ...
    static int numBitsDiffering(int i, int i2) {
        i ^= i2;
        i2 = BITS_SET_IN_HALF_BYTE;
        return ((((((i2[i & 15] + i2[(i >>> 4) & 15]) + i2[(i >>> 8) & 15]) + i2[(i >>> 12) & 15]) + i2[(i >>> 16) & 15]) + i2[(i >>> 20) & 15]) + i2[(i >>> 24) & 15]) + i2[(i >>> 28) & 15];
    }
    ...
    private static FormatInformation doDecodeFormatInformation(int i, int i2) {
        ...
        return i4 <= 3 ? new FormatInformation(i5) : 0;
    }
