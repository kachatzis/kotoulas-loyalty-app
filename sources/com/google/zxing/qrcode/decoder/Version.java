...
public final class Version {
    ...
    private Version(int i, int[] iArr, ECBlocks... eCBlocksArr) {
        ...
        i = 0;
        iArr = eCBlocksArr[0].getECCodewordsPerBlock();
        eCBlocksArr = eCBlocksArr[0].getECBlocks();
        int length = eCBlocksArr.length;
        int i2 = 0;
        while (i < length) {
            ECB ecb = eCBlocksArr[i];
            i2 += ecb.getCount() * (ecb.getDataCodewords() + iArr);
            i++;
        }
    ...
    public static com.google.zxing.qrcode.decoder.Version getProvisionalVersionForDimension(int r2) throws com.google.zxing.FormatException {
...
*/
    ...
    L_0x0005:
        ...
        r2 = getVersionForNumber(r2);	 Catch:{ IllegalArgumentException -> 0x000e }
        return r2;
    L_0x000e:
    ...
    L_0x0013:
        ...
        throw r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.qrcode.decoder.Version.getProvisionalVersionForDimension(int):com.google.zxing.qrcode.decoder.Version");
    }
    ...
    static Version decodeVersionInformation(int i) {
        ...
        return i3 <= 3 ? getVersionForNumber(i4) : 0;
    }
